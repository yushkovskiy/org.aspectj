...
public class FileUtil {
  ...
  static {
    final String name = FileUtil.class.getName() + ".PERMIT_CVS";
   ...
   */
  public static int zipSuffixLength(@Nullable File file) {
   ...
   */
  public static int zipSuffixLength(@Nullable String path) {
    if ((null != path) && (4 < path.length())) {
      final String test = path.substring(path.length() - 4).toLowerCase();
   ...
   */
  public static boolean hasSourceSuffix(@Nullable File file) {
   ...
   */
  public static boolean hasSourceSuffix(@Nullable String path) {
   ...
   */
  public static int sourceSuffixLength(@Nullable File file) {
   ...
   */
  public static int sourceSuffixLength(@Nullable String path) {
    if (LangUtil.isEmpty(path)) {
      return 0;
    }

    for (final Iterator<String> iter = SOURCE_SUFFIXES.iterator(); iter.hasNext(); ) {
      final String suffix = iter.next();
   ...
   */
  public static boolean canReadDir(@Nullable File dir) {
   ...
   */
  public static boolean canReadFile(@Nullable File file) {
   ...
   */
  public static boolean canWriteDir(@Nullable File dir) {
   ...
   */
  public static boolean canWriteFile(@Nullable File file) {
   ...
   */
  public static void throwIaxUnlessCanReadDir(@Nullable File dir, @NotNull String label) {
    if (!canReadDir(dir)) {
   ...
   */
  public static void throwIaxUnlessCanWriteFile(@Nullable File file, @NotNull String label) {
   ...
   * @throws IllegalArgumentException unless dir is a readable directory
   */
  public static void throwIaxUnlessCanWriteDir(@Nullable File dir, @NotNull String label) {
    if (!canWriteDir(dir)) {
   ...
   */
  @NotNull
  public static String[] getPaths(@Nullable File[] files) {
   ...
   */
  @NotNull
  public static String[] getPaths(@Nullable List<File> files) {
   ...
   */
  @NotNull
  public static String fileToClassName(@Nullable File basedir, @NotNull File classFile) {
    LangUtil.throwIaxIfNull(classFile, "classFile");
    String classFilePath = normalizedPath(classFile);
    if (!classFilePath.endsWith(".class")) {
      final String m = classFile + " does not end with .class";
      throw new IllegalArgumentException(m);
    }
    classFilePath = classFilePath.substring(0, classFilePath.length() - 6);
    if (null != basedir) {
      final String basePath = normalizedPath(basedir);
      if (!classFilePath.startsWith(basePath)) {
        final String m = classFile + " does not start with " + basedir;
        throw new IllegalArgumentException(m);
      }
      ...
      for (int i = 0; !found && (i < suffixes.length); i++) {
        final int loc = classFilePath.indexOf(suffixes[i] + "/");
      ...
      if (!found) {
        final int loc = classFilePath.lastIndexOf("/");
   ...
   */
  @NotNull
  public static String normalizedPath(@NotNull File file, @Nullable File basedir) {
   ...
   */
  @NotNull
  public static String flatten(@Nullable File[] files, @Nullable String infix) {
   ...
   */
  @NotNull
  public static String flatten(@NotNull String[] paths, @Nullable String infix) {
    if (null == infix) {
   ...
   */
  @NotNull
  public static String normalizedPath(@Nullable File file) {
   ...
   */
  @NotNull
  public static String weakNormalize(@NotNull String path) {
    if (null != path) {
   ...
   */
  @Nullable
  public static File getBestFile(@Nullable String[] paths) {
    if (null == paths) {
      return null;
    }
    File result = null;
   ...
   */
  @NotNull
  public static File getBestFile(@NotNull File file) {
   ...
   */
  @NotNull
  public static String getBestPath(@NotNull File file) {
    LangUtil.throwIaxIfNull(file, "file");
    if (file.exists()) {
      try {
   ...
   */
  @NotNull
  public static String[] getAbsolutePaths(@Nullable File[] files) {
    if ((null == files) || (0 == files.length)) {
      return new String[0];
    }
    final String[] result = new String[files.length];
   ...
   */
  public static int deleteContents(@NotNull File dir) {
   ...
   * @return the total number of files deleted
   */
  public static int deleteContents(@NotNull File dir, @NotNull FileFilter filter) {
   ...
   * @return the total number of files deleted
   */
  public static int deleteContents(@NotNull File dir, @Nullable FileFilter filter, boolean deleteEmptyDirs) {
    if (null == dir) {
    ...
    final String[] fromFiles = dir.list();
    int result = 0;
    for (int i = 0; i < fromFiles.length; i++) {
      final String string = fromFiles[i];
      final File file = new File(dir, string);
   ...
   */
  public static int copyDir(@NotNull File fromDir, @NotNull File toDir) throws IOException {
   ...
   * @return the total number of files copied
   */
  public static int copyDir(@NotNull File fromDir, @NotNull File toDir, @Nullable final String fromSuffix, @Nullable String toSuffix) throws IOException {
   ...
   * @return the total number of files copied
   */
  public static int copyDir(@NotNull File fromDir, @NotNull File toDir,
                            @Nullable final String fromSuffix, @Nullable final String toSuffix,
                            @Nullable final FileFilter delegate)
      throws IOException {
    ...
    for (int i = 0; i < MAX; i++) {
      ...
      if (fromFile.canRead()) {
        if (fromFile.isDirectory()) {
          ...
          final File targetFile = new File(toDir, filename);
   ...
   */
  @NotNull
  public static String[] listFiles(@Nullable File srcDir) {
   ...
   */
  @NotNull
  public static File[] listFiles(@Nullable File srcDir, @NotNull FileFilter fileFilter) {
   ...
   */
  @NotNull
  public static List<File> listClassFiles(@NotNull File dir) {
    final ArrayList<File> result = new ArrayList<File>();
   ...
   */
  @NotNull
  public static File[] getBaseDirFiles(@NotNull File basedir, @NotNull String[] paths) {
   ...
   */
  @NotNull
  public static File[] getBaseDirFiles(@NotNull File basedir, @NotNull String[] paths, @Nullable String[] suffixes) {
   ...
   */
  @NotNull
  public static File[] copyFiles(@NotNull File srcDir, @NotNull String[] relativePaths, @NotNull File destDir) throws IllegalArgumentException, IOException {
    ...
    for (int i = 0; i < paths.length; i++) {
      ...
      final File src = newFile(srcDir, paths[i]);
      final File dest = newFile(destDir, path);
   ...
   */
  public static void copyFile(@NotNull File fromFile, @NotNull File toFile) throws IOException {
    ...
    if (toFile.isDirectory()) { // existing directory
      ...
      if (fromFile.isFile()) { // file-dir
        final File targFile = new File(toFile, fromFile.getName());
   ...
   */
  @NotNull
  public static File ensureParentWritable(@NotNull File path) {
   ...
   * @throws IOException
   */
  public static void copyValidFiles(@NotNull File fromFile, @NotNull File toFile) throws IOException {
  ...
  public static void copyStream(@NotNull DataInputStream in, @NotNull PrintStream out) throws IOException {
  ...
  public static void copyStream(@NotNull Reader in, @NotNull Writer out) throws IOException {
    final int MAX = 4096;
    final char[] buf = new char[MAX];
    for (int bytesRead = in.read(buf, 0, MAX); bytesRead != -1; bytesRead = in.read(buf, 0, MAX)) {
      out.write(buf, 0, bytesRead);
    }
  }
   ...
   */
  @Nullable
  public static File makeNewChildDir(@NotNull File parent, @Nullable String child) {
   ...
   */
  @Nullable
  public static File getTempDir(@Nullable String name) {
    if (null == name) {
    ...
    try {
      ...
      final File tempParent = tempFile.getParentFile();
  ...
  @NotNull
  public static URL[] getFileURLs(@Nullable File[] files) {
    if ((null == files) || (0 == files.length)) {
      return new URL[0];
    }
    final URL[] result = new URL[files.length]; // XXX dangerous non-copy...
    for (int i = 0; i < result.length; i++) {
  ...
  @SuppressWarnings("deprecation")
  @Nullable
  public static URL getFileURL(@NotNull File file) {
    LangUtil.throwIaxIfNull(file, "file");
    URL result = null;
    try {
      ...
      final String url = "file:" + file.getAbsolutePath().replace('\\', '/');
      result = new URL(url + (file.isDirectory() ? "/" : ""));
    } catch (MalformedURLException e) {
      final String m = "Util.makeURL(\"" + file.getPath() + "\" MUE " + e.getMessage();
   ...
   */
  @Nullable
  public static String writeAsString(@NotNull File file, @Nullable String contents) {
    LangUtil.throwIaxIfNull(file, "file");
    if (null == contents) {
      contents = "";
    }
    ...
    try {
      ...
      final Reader in = new StringReader(contents);
   ...
   */
  @NotNull
  public static boolean[] readBooleanArray(@NotNull DataInputStream s) throws IOException {
   ...
   */
  public static void writeBooleanArray(@NotNull boolean[] a, @NotNull DataOutputStream s) throws IOException {
   ...
   */
  @NotNull
  public static int[] readIntArray(@NotNull DataInputStream s) throws IOException {
    final int len = s.readInt();
   ...
   */
  @NotNull
  public static void writeIntArray(@NotNull int[] a, @NotNull DataOutputStream s) throws IOException {
    final int len = a.length;
    s.writeInt(len);
    for (int i = 0; i < len; i++) {
      s.writeInt(a[i]);
   ...
   */
  @NotNull
  public static String[] readStringArray(@NotNull DataInputStream s) throws IOException {
    final int len = s.readInt();
   ...
   * Writes an int array with our encoding
   */
  public static void writeStringArray(@NotNull String[] a, @NotNull DataOutputStream s) throws IOException {
    if (a == null) {
      s.writeInt(0);
      return;
    }
   ...
   */
  @NotNull
  public static String readAsString(@NotNull File file) throws IOException {
   ...
   */
  @NotNull
  public static byte[] readAsByteArray(@NotNull File file) throws IOException {
    final FileInputStream in = new FileInputStream(file);
    final byte[] ret = FileUtil.readAsByteArray(in);
    in.close();
    return ret;
  }
   ...
   */
  @NotNull
  public static byte[] readAsByteArray(@NotNull InputStream inStream) throws IOException {
    int size = 1024;
    byte[] ba = new byte[size];
    int readSoFar = 0;

    while (true) {
      final int nRead = inStream.read(ba, readSoFar, size - readSoFar);
      if (nRead == -1) {
        break;
      }
      readSoFar += nRead;
      if (readSoFar == size) {
        ...
        final byte[] newBa = new byte[newSize];
    ...
    final byte[] newBa = new byte[readSoFar];
    System.arraycopy(ba, 0, newBa, 0, readSoFar);
    return newBa;
  }

  @Nullable
  public static InputStream getStreamFromZip(@NotNull String zipFile, @NotNull String name) {
    try {
  ...
  @NotNull
  public static List<String> lineSeek(@Nullable String sought, @Nullable List<String> sources,
                                      boolean listAll, @Nullable PrintStream errorSink) {
    if (LangUtil.isEmpty(sought) || LangUtil.isEmpty(sources)) {
      return Collections.emptyList();
    }
    final ArrayList<String> result = new ArrayList<String>();
    for (final Iterator<String> iter = sources.iterator(); iter.hasNext(); ) {
      final String path = iter.next();
      final String error = lineSeek(sought, path, listAll, result);
   ...
   *
   * @param sought     the String text to seek in the file
   * @param sourcePath path to the source files
   * @param listAll    if false, only list first match in file
  ...
  public static String lineSeek(@Nullable String sought, @Nullable String sourcePath, boolean listAll, @NotNull ArrayList<String> sink) {
    ...
    try {
      ...
      final BufferedReader reader = new BufferedReader(fin);
      String line;
      while (null != (line = reader.readLine())) {
        lineNum++;
        final int loc = line.indexOf(sought);
        if (-1 != loc) {
  ...
  @NotNull
  public static BufferedOutputStream makeOutputStream(@NotNull File file) throws FileNotFoundException {
   ...
   */
  public static boolean sleepPastFinalModifiedTime(@Nullable File[] files) {
    if ((null == files) || (0 == files.length)) {
      return true;
    }
    ...
    for (int i = 0; i < files.length; i++) {
      ...
      final long nextModTime = file.lastModified();
  ...
  @NotNull
  public static List<String> makeClasspath(@Nullable URL[] urls) {
   ...
   */
  @NotNull
  private static File newFile(@NotNull File dir, @NotNull String path) {
    if (".".equals(path)) {
      return dir;
    } else if ("..".equals(path)) {
  ...
  private static void listClassFiles(@NotNull final File baseDir, @NotNull ArrayList<File> result) {
  ...
  private static void listFiles(@NotNull final File baseDir, @NotNull ArrayList<File> result, @NotNull FileFilter filter) {
    final File[] files = baseDir.listFiles();
   ...
   */
  private static boolean isValidFileName(@Nullable String input) {
    return ((null != input) && (-1 == input.indexOf(File.pathSeparator)));
  }

  private static void listFiles(@NotNull final File baseDir, @Nullable String dir, @NotNull ArrayList<String> result) {
    ...
    for (int i = 0; i < files.length; i++) {
      final File f = new File(dirFile, files[i]);
      final String path = dirPrefix + files[i];
      if (f.isDirectory()) {
  ...
  @NotNull
  private static String toPathString(@NotNull URL url) {
    try {
  ...
  public static class Pipe implements Runnable {
     ...
     */
    Pipe(@NotNull InputStream in, @NotNull OutputStream out) {
     ...
     */
    Pipe(@NotNull InputStream in, @NotNull OutputStream out, long sleep, boolean closeInput, boolean closeOutput) {
      LangUtil.throwIaxIfNull(in, "in");
    ...
    public void setSnoop(@Nullable ByteArrayOutputStream snoop) {
      this.snoop = snoop;
    }
