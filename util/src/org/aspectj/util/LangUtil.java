...
public final class LangUtil {
  ...
  static {
    ...
    try {
      buf.close();
      final StringBuffer sb = buf.getBuffer();
      if (sb != null) {
        eol = buf.toString();
      }
    } catch (Throwable t) {
  ...
  static {
    try {
      ...
      if (vm == null) {
        ...
        try {
          final String versionString = vm.substring(0, 3);
          final Double temp = new Double(Double.parseDouble(versionString));
   ...
   */
  public static final void throwIaxIfNull(@Nullable final Object o, @Nullable final String name) {
    if (null == o) {
      final String message = "null " + (null == name ? "input" : name);
  ...
  public static final void throwIaxIfNotAssignable(final Object ra[], final Class<?> c, final String name) {
    ...
    final String label = (null == name ? "input" : name);
    for (int i = 0; i < ra.length; i++) {
      if (null == ra[i]) {
        final String m = " null " + label + "[" + i + "]";
        throw new IllegalArgumentException(m);
      } else if (null != c) {
        final Class<?> actualClass = ra[i].getClass();
        if (!c.isAssignableFrom(actualClass)) {
          final String message = label + " not assignable to " + c.getName();
          throw new IllegalArgumentException(message);
        }
      }
    }
  ...
  public static final void throwIaxIfNotAssignable(final Object o, final Class<?> c, final String name) {
    ...
    if (null != c) {
      ...
      if (!c.isAssignableFrom(actualClass)) {
        final String message = name + " not assignable to " + c.getName();
        throw new IllegalArgumentException(message);
      }
    }
  }
   ...
   */
  public static final void throwIaxIfFalse(final boolean test, @NotNull final String message) {
    if (!test) {
      throw new IllegalArgumentException(message);
    }
  }
   ...
   */
  public static boolean isEmpty(@Nullable Object[] ra) {
    return ((null == ra) || (0 == ra.length));
  }
   ...
   * @return ((null == ra) || (0 == ra.length))
   */
  public static boolean isEmpty(@Nullable byte[] ra) {
    return ((null == ra) || (0 == ra.length));
  }
   ...
   */
  @NotNull
  public static String[] split(@Nullable String text) {
   ...
   */
  @NotNull
  public static List<String> commaSplit(@Nullable String input) {
   ...
   */
  @NotNull
  public static String[] splitClasspath(@Nullable String classpath) {
    if (LangUtil.isEmpty(classpath)) {
      return new String[0];
    }
    final StringTokenizer st = new StringTokenizer(classpath, File.pathSeparator);
    final ArrayList<String> result = new ArrayList<String>(st.countTokens());
   ...
   */
  public static boolean getBoolean(@Nullable String propertyName, boolean defaultValue) {
   ...
   */
  @NotNull
  public static List<String> anySplit(@Nullable String input, @Nullable String delim) {
    if (null == input) {
   ...
   */
  @NotNull
  public static List<String> strings(@Nullable String text) {
   ...
   */
  @NotNull
  public static String[][] copyStrings(@NotNull String[][] in) {
   ...
   */
  @Nullable
  public static String[] extractOptions(@Nullable String[] args, @Nullable String[][] options) {
    if (LangUtil.isEmpty(args) || LangUtil.isEmpty(options)) {
      return args;
    }
    final BitSet foundSet = new BitSet();
    ...
    for (int j = 0; j < args.length; j++) {
      ...
      for (int i = 0; !found && (i < options.length); i++) {
        ...
        final String sought = option[0];
        found = sought.equals(args[j]);
        if (found) {
          foundSet.set(i);
          final int doMore = option.length - 1;
          if (0 < doMore) {
            final int MAX = j + doMore;
            if (MAX >= args.length) {
              final String s = "expecting " + doMore + " args after ";
    ...
    if (resultIndex < args.length) {
      final String[] temp = new String[resultIndex];
   ...
   */
  @NotNull
  public static Object[] safeCopy(@Nullable Object[] source, @Nullable Object[] sink) {
   ...
   */
  @NotNull
  public static String unqualifiedClassName(@Nullable Class<?> c) {
    if (null == c) {
      return "null";
    }
   ...
   */
  @Nullable
  public static String unqualifiedClassName(@Nullable Object o) {
   ...
   */
  @Nullable
  public static String replace(@Nullable String in, @Nullable String sought, @Nullable String replace) {
   ...
   */
  @NotNull
  public static String renderExceptionShort(@Nullable Throwable e) {
    if (null == e) {
   ...
   */
  @NotNull
  public static String renderException(@Nullable Throwable t) {
   ...
   */
  @NotNull
  public static String renderException(@Nullable Throwable t, boolean elide) {
    if (null == t) {
      return "null throwable";
    }
    t = unwrapException(t);
    final StringBuffer stack = stackToString(t, false);
    if (elide) {
   ...
   */
  @NotNull
  public static StringBuffer stackToString(@Nullable Throwable throwable, boolean skipMessage) {
    if (null == throwable) {
   ...
   */
  @NotNull
  public static Throwable unwrapException(@NotNull Throwable t) {
    Throwable current = t;
    Throwable next = null;
    while (current != null) {
   ...
   */
  @NotNull
  public static List<Object> arrayAsList(@Nullable Object[] array) {
  ...
  public static String makeClasspath( // XXX dumb implementation
                                      @Nullable String bootclasspath, @Nullable String classpath, @Nullable String classesDir, @Nullable String outputJar) {
   ...
   */
  @NotNull
  public static ProcessController makeProcess(@Nullable ProcessController controller, @NotNull String classpath, @NotNull String mainClass, @Nullable String[] args) {
    final File java = LangUtil.getJavaExecutable();
    ...
    final String[] command = (String[]) cmd.toArray(new String[0]);
    if (null == controller) {
  ...
  public static File getJavaExecutable() {
    ...
    if (null != javaHome) {
      ...
      if (binDir.isDirectory() && binDir.canRead()) {
        final String[] execs = new String[]{"java", "java.exe"};
   ...
   */
  static void elideEndingLines(@Nullable StringChecker checker, @Nullable StringBuffer stack, int maxLines) {
   ...
   */
  private static boolean addIfNotEmpty(@Nullable String input, @Nullable StringBuffer sink, String delimiter) {
  ...
  public static class StringChecker {
     ...
     */
    StringChecker(@NotNull String[] infixes) {
     ...
     */
    public boolean acceptString(@Nullable String input) {
   ...
   */
  public static final class ProcessController {
    /*
    ...
    public final void init(@NotNull String classpath, @NotNull String mainClass, @NotNull String[] args) {
      init(LangUtil.getJavaExecutable(), classpath, mainClass, args);
    }

    public final void init(@NotNull File java, @NotNull String classpath, @NotNull String mainClass, @NotNull String[] args) {
    ...
    public final void init(@NotNull String[] command, @Nullable String label) {
    ...
    public final void setEnvp(@NotNull String[] envp) {
    ...
    public final void setErrSnoop(@Nullable ByteArrayOutputStream snoop) {
      errSnoop = snoop;
      if (null != errStream) {
    ...
    public final void setOutSnoop(@Nullable ByteArrayOutputStream snoop) {
      outSnoop = snoop;
      if (null != outStream) {
    ...
    public final Thread start() {
      ...
      final Runnable processRunner = new Runnable() {
        @Override
        public void run() {
      ...
      final Thread result = new Thread(processRunner, label);
      result.start();
      return result;
    }
    ...
    public final String[] getCommand() {
      final String[] toCopy = command;
      if (LangUtil.isEmpty(toCopy)) {
        return new String[0];
      }
      final String[] result = new String[toCopy.length];
     ...
     * @see #stop()
     */
    protected void doCompleting(@NotNull Thrown thrown, int result) {
    }
     ...
     */
    private synchronized void stop(@Nullable Throwable thrown, int result) {
      if (completed) {
     ...
     *
     * @param processThrown ignored if this.thrown is not null
     */
    @NotNull
    private synchronized Thrown makeThrown(@Nullable Throwable processThrown) {
      if (null != thrown) {
        return thrown;
      }
    ...
    public static class Thrown {
      ...
      private Thrown(@Nullable Throwable fromProcess, @Nullable Throwable fromOutPipe,
                     @Nullable Throwable fromErrPipe, @Nullable Throwable fromInPipe) {
      ...
      private static void append(@NotNull StringBuffer sb, @Nullable Throwable thrown, @NotNull String label) {
        if (null != thrown) {
