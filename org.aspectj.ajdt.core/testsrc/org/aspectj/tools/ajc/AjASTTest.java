...
public class AjASTTest extends AjASTTestCase {
  ...
  public void testNewDefaultPointcut() {
    final AjAST ajast = createAjAST();
    final DefaultPointcut p = ajast.newDefaultPointcut();
  ...
  public void testNewReferencePointcut() {
    final AjAST ajast = createAjAST();
    final ReferencePointcut p = ajast.newReferencePointcut();
  ...
  public void testNewAndPointcut() {
    final AjAST ajast = createAjAST();
    final AndPointcut p = ajast.newAndPointcut();
  ...
  public void testGetAndSetLeftOfAndPointcut() {
    final AjAST ajast = createAjAST();
    final AndPointcut ap = ajast.newAndPointcut();
  ...
  public void testNewCflowPointcut() {
    final AjAST ajast = createAjAST();
    final CflowPointcut p = ajast.newCflowPointcut();
  ...
  public void testGetAndSetBodyOfCflowPointcut() {
    ...
    final ReferencePointcut rp = ajast.newReferencePointcut();
    p.setBody(rp);
  ...
  public void testNewNotPointcut() {
    final AjAST ajast = createAjAST();
    final NotPointcut p = ajast.newNotPointcut();
  ...
  public void testNewOrPointcut() {
    final AjAST ajast = createAjAST();
    final OrPointcut p = ajast.newOrPointcut();
  ...
  public void testGetAndSetLeftOfOrPointcut() {
    final AjAST ajast = createAjAST();
    final OrPointcut op = ajast.newOrPointcut();
  ...
  public void testNewPerCflow() {
    final AjAST ajast = createAjAST();
    final PerCflow p = ajast.newPerCflow();
  ...
  public void testNewPerObject() {
    final AjAST ajast = createAjAST();
    final PerObject p = ajast.newPerObject();
  ...
  public void testNewPerTypeWithin() {
    final AjAST ajast = createAjAST();
    final PerTypeWithin p = ajast.newPerTypeWithin();
  ...
  public void testNewDefaultTypePattern() {
    final AjAST ajast = createAjAST();
    final DefaultTypePattern p = ajast.newDefaultTypePattern();
  ...
  public void testPropertyDescriptorsForDefaultTypePattern() {
    ...
    final List props = DefaultTypePattern.propertyDescriptors(AST.JLS3);
  ...
  public void testCloneDefaultTypePattern() {
    final AjAST ajast = createAjAST();
    final DefaultTypePattern d = ajast.newDefaultTypePattern();
    d.setDetail("new detail");
    final DefaultTypePattern copy = (DefaultTypePattern) ASTNode.copySubtree(ajast, d);
  ...
  public void testNewSignaturePattern() {
    final AjAST ajast = createAjAST();
    final SignaturePattern p = ajast.newSignaturePattern();
  ...
  public void testPropertyDescriptorsForSignaturePattern() {
    ...
    final List props = SignaturePattern.propertyDescriptors(AST.JLS3);
    assertEquals("there should be no properties for the DefaultTypePattern", 0, props.size());
  }
  ...
  public void testCloneDefaultSignaturePattern() {
    ...
    final SignaturePattern copy = (SignaturePattern) ASTNode.copySubtree(ajast, p);
    assertEquals("the copy should have detail 'new detail'", "new detail", copy.getDetail());
  }
  ...
  public void testNewPointcutDeclaration() {
    final AjAST ajast = createAjAST();
    final PointcutDeclaration pd = ajast.newPointcutDeclaration();
  ...
  public void testGetAndSetPointcutArguments() {
    ...
    final List l = pd.parameters();
    assertEquals("there shouldn't be any arguments associated with" + "the pointcut yet", 0, l.size());
    final SingleVariableDeclaration p1 = ajast.newSingleVariableDeclaration();
    l.add(p1);
  ...
  public void testPropertyDescriptorsForPointcutDeclaration() {
    ...
    final List props = PointcutDeclaration.propertyDescriptors(AST.JLS3);
    ...
    for (final Iterator iter = props.iterator(); iter.hasNext(); ) {
      ...
      if ((o instanceof ChildPropertyDescriptor)) {
        final ChildPropertyDescriptor element = (ChildPropertyDescriptor) o;
        ...
        final ChildListPropertyDescriptor element = (ChildListPropertyDescriptor) o;
  ...
  public void testClonePointcutDeclaration() {
    final AjAST ajast = createAjAST();
    final PointcutDeclaration d = ajast.newPointcutDeclaration();
    d.setName(ajast.newSimpleName("pointcut_name"));
    d.parameters().add(ajast.newSingleVariableDeclaration());
    final PointcutDeclaration copy = (PointcutDeclaration) ASTNode.copySubtree(ajast, d);
  ...
  public void testInternalPointcutDeclaration() {
    ...
    for (final Iterator iter = props.iterator(); iter.hasNext(); ) {
      ...
      if (o instanceof ChildPropertyDescriptor) {
        ...
        final boolean isIExtendedModifier = element.getElementType().equals(IExtendedModifier.class);
        final boolean isSingleVariable = element.getElementType().equals(SingleVariableDeclaration.class);
        ...
        final SimplePropertyDescriptor element = (SimplePropertyDescriptor) o;
        assertNotNull(
    ...
    for (final Iterator iter = props.iterator(); iter.hasNext(); ) {
      ...
      if (o instanceof ChildPropertyDescriptor) {
        ...
        if (element.getId().equals("designator")) {
          ...
          final SimpleName sn = ajast.newSimpleName("p");
  ...
  public void testNewAspectDeclaration() {
    final AjAST ajast = createAjAST();
    final AspectDeclaration ad = ajast.newAspectDeclaration();
  ...
  public void testPropertyDescriptorsForAspectDeclaration() {
    ...
    final List props = AspectDeclaration.propertyDescriptors(AST.JLS3);
    boolean foundJavadoc = false;
  ...
  public void testCloneAspectDeclaration() {
    final AjAST ajast = createAjAST();
    final AspectDeclaration d = ajast.newAspectDeclaration();
    d.setPerClause(ajast.newPerTypeWithin());
    d.setPrivileged(true);
    final AspectDeclaration copy = (AspectDeclaration) ASTNode.copySubtree(ajast, d);
  ...
  public void testSetPerClauseInAspectDeclaration() {
    ...
    final PerCflow pcf = ajast.newPerCflow();
    ad.setPerClause(pcf);
  ...
  public void testNewAfterAdviceDeclaration() {
    final AjAST ajast = createAjAST();
    final AfterAdviceDeclaration ad = ajast.newAfterAdviceDeclaration();
  ...
  public void testNewBeforeAdviceDeclaration() {
    final AjAST ajast = createAjAST();
    final BeforeAdviceDeclaration bd = ajast.newBeforeAdviceDeclaration();
  ...
  public void testNewAfterReturningAdviceDeclaration() {
    final AjAST ajast = createAjAST();
    final AfterReturningAdviceDeclaration d = ajast.newAfterReturningAdviceDeclaration();
  ...
  public void testGetAndSetReturning() {
    ...
    assertNull("by default there should be no returning property associated with" + " the AfterReturningAdviceDeclaration", d
        .getReturning());
    final SingleVariableDeclaration s = ajast.newSingleVariableDeclaration();
    d.setReturning(s);
  ...
  public void testNewAfterThrowingAdviceDeclaration() {
    final AjAST ajast = createAjAST();
    final AfterThrowingAdviceDeclaration d = ajast.newAfterThrowingAdviceDeclaration();
  ...
  public void testNewAroundAdviceDeclaration() {
    final AjAST ajast = createAjAST();
    final AroundAdviceDeclaration d = ajast.newAroundAdviceDeclaration();
  ...
  public void testGetAndSetReturnTypeJLS2() {
    final AjAST ajast = createAjAST(AST.JLS2);
    final AroundAdviceDeclaration d = ajast.newAroundAdviceDeclaration();
    final Type t = d.getReturnType();
    ...
    final SimpleType s = ajast.newSimpleType(ajast.newSimpleName("name"));
    d.setReturnType(s);
  ...
  public void testNewITDFieldDeclaration() {
    final AjAST ajast = createAjAST();
    final InterTypeFieldDeclaration d = ajast.newInterTypeFieldDeclaration();
  ...
  public void testNewITDMethodDeclaration() {
    final AjAST ajast = createAjAST();
    final InterTypeMethodDeclaration d = ajast.newInterTypeMethodDeclaration();
  ...
  public void testNewAjTypeDeclaration() {
    final AjAST ajast = createAjAST();
    final AjTypeDeclaration d = ajast.newAjTypeDeclaration();
  ...
  public void testPropertyDescriptorsForAjTypeDeclaration() {
    ...
    final List props = AjTypeDeclaration.propertyDescriptors(AST.JLS3);
  ...
  public void testCloneAjTypeDeclaration() {
    ...
    final AjTypeDeclaration d = ajast.newAjTypeDeclaration();
    d.setAspect(true);
    final AjTypeDeclaration copy = (AjTypeDeclaration) ASTNode.copySubtree(ajast, d);
  ...
  public void testPropertyDescriptorsForAjTypeDeclaration3() {
    ...
    final List props = TypeDeclaration.propertyDescriptors(AST.JLS3);
    boolean foundAspect = false;
    for (final Iterator iter = props.iterator(); iter.hasNext(); ) {
      final Object o = iter.next();
      if (o instanceof SimplePropertyDescriptor) {
  ...
  public void testNewDeclareAtFieldDeclaration() {
    final AjAST ajast = createAjAST();
    final DeclareAtFieldDeclaration d = ajast.newDeclareAtFieldDeclaration();
  ...
  public void testPropertyDescriptorsForDeclareAtField() {
    ...
    final List props = DeclareAtFieldDeclaration.propertyDescriptors(AST.JLS3);
    boolean foundJavadoc = false;
    boolean foundPattern = false;
    boolean foundAnnotationName = false;
    for (final Iterator iter = props.iterator(); iter.hasNext(); ) {
      final ChildPropertyDescriptor element = (ChildPropertyDescriptor) iter.next();
      final String id = element.getId();
      if (id.equals("javadoc")) {
        foundJavadoc = true;
  ...
  public void testCloneDeclareAtField() {
    ...
    d.setAnnotationName(ajast.newSimpleName("MyAnnotation"));
    final DeclareAtFieldDeclaration copy = (DeclareAtFieldDeclaration) ASTNode.copySubtree(ajast, d);
  ...
  public void testInternalDeclareAtField() {
    ...
    for (final Iterator iter = props.iterator(); iter.hasNext(); ) {
      ...
      if (element.getId().equals("pattern")) {
        ...
        final SimpleName s = ajast.newSimpleName("MyAnnotation");
  ...
  public void testNewDeclareAtMethodDeclaration() {
    final AjAST ajast = createAjAST();
    final DeclareAtMethodDeclaration d = ajast.newDeclareAtMethodDeclaration();
  ...
  public void testPropertyDescriptorsForDeclareAtMethod() {
    ...
    final List props = DeclareAtMethodDeclaration.propertyDescriptors(AST.JLS3);
    boolean foundJavadoc = false;
    boolean foundPattern = false;
    boolean foundAnnotationName = false;
    for (final Iterator iter = props.iterator(); iter.hasNext(); ) {
  ...
  public void testCloneDeclareAtMethod() {
    ...
    d.setPatternNode(ajast.newSignaturePattern());
    d.setAnnotationName(ajast.newSimpleName("MyAnnotation"));
    final DeclareAtMethodDeclaration copy = (DeclareAtMethodDeclaration) ASTNode.copySubtree(ajast, d);
  ...
  public void testNewDeclareAtConstructorDeclaration() {
    final AjAST ajast = createAjAST();
    final DeclareAtConstructorDeclaration d = ajast.newDeclareAtConstructorDeclaration();
  ...
  public void testPropertyDescriptorsForDeclareAtConstructor() {
    ...
    final List props = DeclareAtConstructorDeclaration.propertyDescriptors(AST.JLS3);
    boolean foundJavadoc = false;
    boolean foundPattern = false;
    boolean foundAnnotationName = false;
    for (final Iterator iter = props.iterator(); iter.hasNext(); ) {
  ...
  public void testCloneDeclareAtConstructor() {
    ...
    d.setPatternNode(ajast.newSignaturePattern());
    d.setAnnotationName(ajast.newSimpleName("MyAnnotation"));
    final DeclareAtConstructorDeclaration copy = (DeclareAtConstructorDeclaration) ASTNode.copySubtree(ajast, d);
  ...
  public void testNewDeclareAtTypeDeclaration() {
    final AjAST ajast = createAjAST();
    final DeclareAtTypeDeclaration d = ajast.newDeclareAtTypeDeclaration();
  ...
  public void testPropertyDescriptorsForDeclareAtType() {
    ...
    final List props = DeclareAtTypeDeclaration.propertyDescriptors(AST.JLS3);
    boolean foundJavadoc = false;
    boolean foundPattern = false;
    boolean foundAnnotationName = false;
    for (final Iterator iter = props.iterator(); iter.hasNext(); ) {
  ...
  public void testGetAndSetPatternNodeInDeclareAtType() {
    ...
    assertNull("by default there should be no typePattern associated with" + " the declare @type annotation", d
        .getPatternNode());
    final DefaultTypePattern dtp = ajast.newDefaultTypePattern();
  ...
  public void testCloneDeclareAtType() {
    ...
    d.setAnnotationName(ajast.newSimpleName("MyAnnotation"));
    final DeclareAtTypeDeclaration copy = (DeclareAtTypeDeclaration) ASTNode.copySubtree(ajast, d);
  ...
  public void testNewDeclareErrorDeclaration() {
    final AjAST ajast = createAjAST();
    final DeclareErrorDeclaration d = ajast.newDeclareErrorDeclaration();
  ...
  public void testPropertyDescriptorsForDeclareErrorDeclaration() {
    ...
    final List props = DeclareErrorDeclaration.propertyDescriptors(AST.JLS3);
    boolean foundJavadoc = false;
  ...
  public void testGetAndSetMessageInErrorDeclaration() {
    ...
    final StringLiteral s = ajast.newStringLiteral();
    d.setMessage(s);
  ...
  public void testCloneDeclareErrorDeclaration() {
    ...
    final DeclareErrorDeclaration copy = (DeclareErrorDeclaration) ASTNode.copySubtree(ajast, d);
  ...
  public void testNewDeclareParentsDeclaration() {
    final AjAST ajast = createAjAST();
    final DeclareParentsDeclaration d = ajast.newDeclareParentsDeclaration();
  ...
  public void testPropertyDescriptorsForDeclareParentsDeclaration() {
    ...
    final List props = DeclareParentsDeclaration.propertyDescriptors(AST.JLS3);
    boolean foundJavadoc = false;
  ...
  public void testTypePatternsInDeclareParents() {
    final AjAST ajast = createAjAST();
    final DeclareParentsDeclaration d = ajast.newDeclareParentsDeclaration();
    final List l = d.parentTypePatterns();
  ...
  public void testCloneDeclareParentsDeclaration() {
    ...
    final DeclareParentsDeclaration copy = (DeclareParentsDeclaration) ASTNode.copySubtree(ajast, d);
  ...
  public void testNewDeclarePrecedenceDeclaration() {
    final AjAST ajast = createAjAST();
    final DeclarePrecedenceDeclaration d = ajast.newDeclarePrecedenceDeclaration();
  ...
  public void testPropertyDescriptorsForDeclarePrecedence() {
    ...
    final List props = DeclarePrecedenceDeclaration.propertyDescriptors(AST.JLS3);
    boolean foundJavadoc = false;
  ...
  public void testCloneDeclarePrecedenceDeclaration() {
    ...
    final DeclarePrecedenceDeclaration copy = (DeclarePrecedenceDeclaration) ASTNode.copySubtree(ajast, d);
  ...
  public void testNewDeclareSoftDeclaration() {
    final AjAST ajast = createAjAST();
    final DeclareSoftDeclaration d = ajast.newDeclareSoftDeclaration();
  ...
  public void testPropertyDescriptorsForDeclareSoftDeclaration() {
    ...
    final List props = DeclareSoftDeclaration.propertyDescriptors(AST.JLS3);
    boolean foundJavadoc = false;
    boolean foundPointcut = false;
    boolean foundTypePattern = false;
    for (final Iterator iter = props.iterator(); iter.hasNext(); ) {
  ...
  public void testCloneDeclareSoftDeclaration() {
    ...
    final DeclareSoftDeclaration copy = (DeclareSoftDeclaration) ASTNode.copySubtree(ajast, d);
  ...
  public void testNewDeclareWarningDeclaration() {
    final AjAST ajast = createAjAST();
    final DeclareWarningDeclaration d = ajast.newDeclareWarningDeclaration();
  ...
  public void testPropertyDescriptorsForDeclareWarningDeclaration() {
    ...
    final List props = DeclareWarningDeclaration.propertyDescriptors(AST.JLS3);
    boolean foundJavadoc = false;
    boolean foundPointcut = false;
    boolean foundMessage = false;
    for (final Iterator iter = props.iterator(); iter.hasNext(); ) {
  ...
  public void testCloneDeclareWarningDeclaration() {
    ...
    d.setPointcut(ajast.newAndPointcut());
    d.setMessage(ajast.newStringLiteral());
    final DeclareWarningDeclaration copy = (DeclareWarningDeclaration) ASTNode.copySubtree(ajast, d);
  ...
  public void testJavadocCommentForDeclareExists_pr150467() {
    ...
    final Javadoc javadoc = ((DeclareParentsDeclaration) ((TypeDeclaration) cu.types().get(0)).bodyDeclarations().get(0))
        .getJavadoc();
  ...
  protected static void assertExpression(String expectedExpression, TypePattern node) {
  ...
  protected static void assertNodeType(Class<?> expected, TypePattern node) {
