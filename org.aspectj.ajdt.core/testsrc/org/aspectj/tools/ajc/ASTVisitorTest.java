...
public class ASTVisitorTest extends TestCase {
  ...
  private static void check(String source, String expectedOutput) {
    final ASTParser parser = ASTParser.newParser(AST.JLS3);//JLS2); // ajh02: need to use 2 for returnType - in 3 it has "returnType2"
    ...
    cu2.accept(visitor);
    final String result = visitor.toString();
    System.err.println("actual:\n" + result);
    assertTrue("Expected:\n" + expectedOutput + "====Actual:\n" + result,
        expectedOutput.equals(result));
  }

  private static void checkJLS3(String source, String expectedOutput) {
  ...
  protected static CompilationUnit createAST(char[] source) {
    final ASTParser parser = ASTParser.newParser(AST_INTERNAL_JLS2);
