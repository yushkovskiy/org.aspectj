...
public class CompilationResult {
   ...
   * @see org.aspectj.tools.ajc.AjcTestCase
   */
  public List<IMessage> getFailMessages() {
    return failMessages;
  }

  public List<IMessage> getWeaveMessages() {
  ...
  public String toString() {
    ...
    final int totalMessages = infoMessages.size() + warningMessages.size() + errorMessages.size() + failMessages.size() + weaveMessages.size();
    ...
    buff.append("\n");
    int msgNo = 1;
    for (final Iterator iter = failMessages.iterator(); iter.hasNext(); ) {
      buff.append("[fail ");
      buff.append(msgNo++);
      buff.append("] ");
    ...
    msgNo = 1;
    for (final Iterator iter = warningMessages.iterator(); iter.hasNext(); ) {
      buff.append("[warning ");
      buff.append(msgNo++);
      buff.append("] ");
      buff.append(iter.next().toString());
    ...
    msgNo = 1;
    for (final Iterator iter = weaveMessages.iterator(); iter.hasNext(); ) {
      buff.append("[weaveInfo ");
      buff.append(msgNo++);
      buff.append("] ");
      buff.append(iter.next().toString());
