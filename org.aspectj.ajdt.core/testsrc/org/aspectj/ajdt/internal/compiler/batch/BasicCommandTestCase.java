...
public class BasicCommandTestCase extends CommandTestCase {
  ...
  public void testImplicitOutputDir() {
    ...
    final File f1 = new File(AjdtAjcTests.TESTDATA_PATH + "/src1/p1/Foo.class");
    final File f2 = new File(AjdtAjcTests.TESTDATA_PATH + "/src1/WrongPackage.class");
    final File f3 = new File(AjdtAjcTests.TESTDATA_PATH + "/src1/WrongPackage$1.class");
  ...
  public void testSizeChanges() {
    final File f1 = new File(getSandboxName(), "SizeIssues.class");
