...
public class JavadocTest extends AjcTestCase {
  ...
  public void testMissingJavadoc() {
    final String[] args = new String[]{"World.java", "-warn:allJavadoc"};

    final List<Message> warningMessages = new ArrayList<Message>();
    ...
    final MessageSpec spec = new MessageSpec(warningMessages, null);
