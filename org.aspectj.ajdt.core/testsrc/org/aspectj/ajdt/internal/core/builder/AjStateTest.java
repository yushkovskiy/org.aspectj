...
public class AjStateTest extends TestCase {
  ...
  public void testReorderClasspath() {
    final String o = newConfig.getClasspath().remove(0);
  ...
  protected void setUp() throws Exception {
    ...
    oldConfig = new AjBuildConfig(null);
    newConfig = new AjBuildConfig(null);
    final List<String> cp = new ArrayList<String>();
    cp.add("adir");
    cp.add("ajar.jar");
    oldConfig.setClasspath(cp);
    newConfig.setClasspath(new ArrayList<String>(cp));
    final List<File> ap = new ArrayList<File>();
