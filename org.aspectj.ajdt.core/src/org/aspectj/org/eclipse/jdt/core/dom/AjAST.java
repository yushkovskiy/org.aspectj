...
public class AjAST extends AST {
  ...
  public static CompilationUnit convertCompilationUnit(
    ...
    final AjAST ast = AjAST.newAjAST(level);
    final int savedDefaultNodeFlag = ast.getDefaultNodeFlag();
    ...
    final CompilationUnit unit = converter.convert(compilationUnitDeclaration, source);
  ...
  public AspectDeclaration newAspectDeclaration() {
    final AspectDeclaration result = new AspectDeclaration(this);
    return result;
  }
  ...
  public AjTypeDeclaration newAjTypeDeclaration() {
    final AjTypeDeclaration result = new AjTypeDeclaration(this);
    return result;
  }
  ...
  public AfterAdviceDeclaration newAfterAdviceDeclaration() {
    final AfterAdviceDeclaration result = new AfterAdviceDeclaration(this);
    return result;
  }
  ...
  public AfterReturningAdviceDeclaration newAfterReturningAdviceDeclaration() {
    final AfterReturningAdviceDeclaration result = new AfterReturningAdviceDeclaration(this);
    return result;
  }
  ...
  public AfterThrowingAdviceDeclaration newAfterThrowingAdviceDeclaration() {
    final AfterThrowingAdviceDeclaration result = new AfterThrowingAdviceDeclaration(this);
    return result;
  }
  ...
  public BeforeAdviceDeclaration newBeforeAdviceDeclaration() {
    final BeforeAdviceDeclaration result = new BeforeAdviceDeclaration(this);
    return result;
  }
  ...
  public AroundAdviceDeclaration newAroundAdviceDeclaration() {
    final AroundAdviceDeclaration result = new AroundAdviceDeclaration(this);
    return result;
  }
  ...
  public DeclareAtConstructorDeclaration newDeclareAtConstructorDeclaration() {
    final DeclareAtConstructorDeclaration result = new DeclareAtConstructorDeclaration(this);
    return result;
  }
  ...
  public DeclareAtFieldDeclaration newDeclareAtFieldDeclaration() {
    final DeclareAtFieldDeclaration result = new DeclareAtFieldDeclaration(this);
    return result;
  }
  ...
  public DeclareAtMethodDeclaration newDeclareAtMethodDeclaration() {
    final DeclareAtMethodDeclaration result = new DeclareAtMethodDeclaration(this);
    return result;
  }
  ...
  public DeclareAtTypeDeclaration newDeclareAtTypeDeclaration() {
    final DeclareAtTypeDeclaration result = new DeclareAtTypeDeclaration(this);
    return result;
  }
  ...
  public DeclareErrorDeclaration newDeclareErrorDeclaration() {
    final DeclareErrorDeclaration result = new DeclareErrorDeclaration(this);
    return result;
  }
  ...
  public DeclareParentsDeclaration newDeclareParentsDeclaration() {
    final DeclareParentsDeclaration result = new DeclareParentsDeclaration(this);
    return result;
  }
  ...
  public DeclarePrecedenceDeclaration newDeclarePrecedenceDeclaration() {
    final DeclarePrecedenceDeclaration result = new DeclarePrecedenceDeclaration(this);
    return result;
  }
  ...
  public DeclareSoftDeclaration newDeclareSoftDeclaration() {
    final DeclareSoftDeclaration result = new DeclareSoftDeclaration(this);
    return result;
  }
  ...
  public DeclareWarningDeclaration newDeclareWarningDeclaration() {
    final DeclareWarningDeclaration result = new DeclareWarningDeclaration(this);
    return result;
  }
  ...
  public InterTypeFieldDeclaration newInterTypeFieldDeclaration() {
    final InterTypeFieldDeclaration result = new InterTypeFieldDeclaration(this);
    return result;
  }
  ...
  public InterTypeMethodDeclaration newInterTypeMethodDeclaration() {
    final InterTypeMethodDeclaration result = new InterTypeMethodDeclaration(this);
    return result;
  }
  ...
  public PointcutDeclaration newPointcutDeclaration() {
    final PointcutDeclaration result = new PointcutDeclaration(this);
    return result;
  }
  ...
  public AndPointcut newAndPointcut() {
    final AndPointcut result = new AndPointcut(this);
    return result;
  }
  ...
  public CflowPointcut newCflowPointcut() {
    final CflowPointcut result = new CflowPointcut(this);
    return result;
  }
  ...
  public NotPointcut newNotPointcut() {
    final NotPointcut result = new NotPointcut(this);
    return result;
  }
  ...
  public OrPointcut newOrPointcut() {
    final OrPointcut result = new OrPointcut(this);
    return result;
  }
  ...
  public PerCflow newPerCflow() {
    final PerCflow result = new PerCflow(this);
    return result;
  }
  ...
  public PerObject newPerObject() {
    final PerObject result = new PerObject(this);
    return result;
  }
  ...
  public PerTypeWithin newPerTypeWithin() {
    final PerTypeWithin result = new PerTypeWithin(this);
    return result;
  }
  ...
  public ReferencePointcut newReferencePointcut() {
    final ReferencePointcut result = new ReferencePointcut(this);
    return result;
  }
  ...
  public DefaultPointcut newDefaultPointcut() {
    final DefaultPointcut result = new DefaultPointcut(this, "");
    return result;
  }
  ...
  public DefaultTypePattern newDefaultTypePattern() {
    final DefaultTypePattern result = new DefaultTypePattern(this, "");
    return result;
  }
  ...
  public SignaturePattern newSignaturePattern() {
    final SignaturePattern result = new SignaturePattern(this, "");
    return result;
  }
}
