...
public class DeclareAtConstructorDeclaration extends DeclareAnnotationDeclaration {
  ...
  static {
    final List propertyList = new ArrayList(3);
  ...
  ASTNode clone0(AST target) {
    final DeclareAtConstructorDeclaration result = new DeclareAtConstructorDeclaration(target);
   ...
   *
   * @param apiLevel the API level; one of the <code>AST.JLS&ast;</code>
   *                 constants
