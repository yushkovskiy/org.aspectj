...
public class AndPointcut extends PointcutDesignator {
  ...
  public void setLeft(PointcutDesignator left) {
    ...
    final ASTNode oldChild = this.left;
  ...
  public void setRight(PointcutDesignator right) {
    ...
    final ASTNode oldChild = this.right;
  ...
  public static List propertyDescriptors(int apiLevel) {
    final List propertyList = new ArrayList(2);
  ...
  ASTNode clone0(AST target) {
    final AndPointcut result = new AndPointcut(target);
