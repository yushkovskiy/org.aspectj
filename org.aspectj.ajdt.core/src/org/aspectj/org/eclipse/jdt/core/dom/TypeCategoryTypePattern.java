...
public class TypeCategoryTypePattern extends TypePattern {
   ...
   *
   * @param ast          must not be null
   * @param typeCategory as defined in the corresponding weaver node type
  ...
  ASTNode clone0(AST target) {
    final ASTNode cloned = new TypeCategoryTypePattern(target, getTypeCategory());
