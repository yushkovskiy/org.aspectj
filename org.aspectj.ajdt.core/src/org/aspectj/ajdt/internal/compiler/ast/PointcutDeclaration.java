...
public class PointcutDeclaration extends AjMethodDeclaration {
  ...
  private static boolean isAtAspectJ(TypeDeclaration typeDec) {
    if (typeDec.annotations == null)
      return false;

    for (int i = 0; i < typeDec.annotations.length; i++) {
      final Annotation annotation = typeDec.annotations[i];
  ...
  public void addAtAspectJAnnotations() {
    ...
    final Annotation pcutAnnotation = AtAspectJAnnotationFactory.createPointcutAnnotation(getPointcutText(), argNames,
  ...
  public ResolvedPointcutDefinition makeResolvedPointcutDefinition(EclipseFactory inWorld) {
    ...
    final UnresolvedType utDeclaringClass = inWorld.fromBinding(declaringClass);
    final UnresolvedType[] utParameters = inWorld.fromBindings(parameters);
