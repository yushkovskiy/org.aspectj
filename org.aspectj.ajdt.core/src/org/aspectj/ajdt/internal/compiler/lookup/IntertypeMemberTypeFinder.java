...
public class IntertypeMemberTypeFinder implements ITypeFinder {
  ...
  private final Set<ReferenceBinding> intertypeMemberTypes = new HashSet<ReferenceBinding>();
  ...
  public ReferenceBinding[] getMemberTypes() {
    final ReferenceBinding[] array = new ReferenceBinding[intertypeMemberTypes.size()];
