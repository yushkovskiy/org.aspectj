...
public class EclipseShadow extends Shadow {
  ...
  // --- factory methods
  @Nullable
  public static EclipseShadow makeShadow(@NotNull EclipseFactory world, @NotNull ASTNode astNode, @NotNull ReferenceContext context) {
    // XXX make sure we're getting the correct declaring type at call-site
    if (astNode instanceof AllocationExpression) {
      final AllocationExpression e = (AllocationExpression) astNode;
      ...
      final MessageSend e = (MessageSend) astNode;
      if (e.isSuperAccess())
      ...
      final AbstractMethodDeclaration e = (AbstractMethodDeclaration) astNode;
