...
public final class AjcMemberMaker {
  ...
  public static ResolvedMember privilegedAccessMethodForFieldGet(UnresolvedType aspectType, Member field, boolean shortSyntax) {
    ...
    if (shortSyntax) {
      ...
      final StringBuffer name = new StringBuffer("ajc$get$");
      name.append(field.getName());
      return new ResolvedMemberImpl(Member.METHOD, fieldDeclaringType, PUBLIC_STATIC, field.getReturnType(), name.toString(),
          args);
    } else {
      final String getterName = NameMangler.privilegedAccessMethodForFieldGet(field.getName(), fieldDeclaringType, aspectType);
      final String sig;
      if (Modifier.isStatic(field.getModifiers())) {
  ...
  public static ResolvedMember privilegedAccessMethodForFieldSet(UnresolvedType aspectType, Member field, boolean shortSyntax) {
    ...
    if (shortSyntax) {
      ...
      final StringBuffer name = new StringBuffer("ajc$set$");
      name.append(field.getName());
      return new ResolvedMemberImpl(Member.METHOD, fieldDeclaringType, PUBLIC_STATIC, UnresolvedType.VOID, name.toString(),
          args);
    } else {
      final String setterName = NameMangler.privilegedAccessMethodForFieldSet(field.getName(), fieldDeclaringType, aspectType);
      final String sig;
      if (Modifier.isStatic(field.getModifiers())) {
  ...
  public static ResolvedMember interFieldInterfaceSetter(@NotNull ResolvedMember field, @NotNull ResolvedType onType, UnresolvedType aspectType) {
    ...
    final ResolvedMember rm = new ResolvedMemberImpl(Member.METHOD, onType, modifiers, UnresolvedType.VOID,
  ...
  public static ResolvedMember interFieldInterfaceGetter(ResolvedMember field, ResolvedType onType, UnresolvedType aspectType) {
    ...
    final ResolvedMember rm = new ResolvedMemberImpl(Member.METHOD, onType, modifiers, field.getReturnType(),
  ...
  public static ResolvedMember interMethod(@NotNull ResolvedMember meth, UnresolvedType aspectType, boolean onInterface) {
    ...
    final ResolvedMemberImpl rmi = new ResolvedMemberImpl(Member.METHOD, meth.getDeclaringType(), modifiers, meth.getReturnType(),
  ...
  public static ResolvedMember interMethodDispatcher(@NotNull ResolvedMember meth, UnresolvedType aspectType) {
    ...
    final ResolvedMemberImpl rmi = new ResolvedMemberImpl(Member.METHOD, aspectType, PUBLIC_STATIC, meth.getReturnType(),
  ...
  private static ResolvedMember addCookieTo(ResolvedMember ret, UnresolvedType aspectType) {
    ...
    final UnresolvedType[] freshParams = UnresolvedType.add(params, aspectType);
