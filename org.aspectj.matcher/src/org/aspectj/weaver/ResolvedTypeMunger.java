...
public abstract class ResolvedTypeMunger {
  ...
  public ResolvedTypeMunger(Kind kind, ResolvedMember signature) {
    ...
    final UnresolvedType declaringType = signature != null ? signature.getDeclaringType() : null;
  ...
  public boolean matches(ResolvedType matchType, ResolvedType aspectType) {
    ...
    if (matchType.equals(onType)) {
      if (!onType.isExposedToWeaver()) {
        ...
        final boolean ok = (onType.isInterface() && (onType.lookupMemberWithSupersAndITDs(getSignature()) != null));
