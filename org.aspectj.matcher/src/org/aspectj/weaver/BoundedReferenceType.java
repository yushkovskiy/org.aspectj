...
public class BoundedReferenceType extends ReferenceType {
  ...
  private final ResolvedType upperBound;
  ...
  public UnresolvedType parameterize(Map<String, UnresolvedType> typeBindings) {
    ...
    final ReferenceType[] parameterizedAdditionalInterfaces = new ReferenceType[additionalInterfaceBounds == null ? 0
  ...
  public boolean canBeCoercedTo(ResolvedType aCandidateType) {
    ...
    if (aCandidateType.isGenericWildcard()) {
      final BoundedReferenceType boundedRT = (BoundedReferenceType) aCandidateType;
      final ResolvedType myUpperBound = (ResolvedType) getUpperBound();
      final ResolvedType myLowerBound = (ResolvedType) getLowerBound();
      if (isExtends()) {
  ...
  public ResolvedType[] getDeclaredInterfaces() {
    final ResolvedType[] interfaces = super.getDeclaredInterfaces();
    if (additionalInterfaceBounds.length > 0) {
      final ResolvedType[] allInterfaces = new ResolvedType[interfaces.length + additionalInterfaceBounds.length];
