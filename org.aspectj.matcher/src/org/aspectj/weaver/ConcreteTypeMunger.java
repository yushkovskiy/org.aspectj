...
public abstract class ConcreteTypeMunger implements PartialOrder.PartialComparable {
  ...
  public boolean equivalentTo(Object other) {
    ...
    final ConcreteTypeMunger o = (ConcreteTypeMunger) other;
    final ResolvedTypeMunger otherTypeMunger = o.getMunger();
    final ResolvedTypeMunger thisTypeMunger = getMunger();
  ...
  public int compareTo(@NotNull Object other) {
    ...
    final ResolvedType otherAspect = o.aspectType;
