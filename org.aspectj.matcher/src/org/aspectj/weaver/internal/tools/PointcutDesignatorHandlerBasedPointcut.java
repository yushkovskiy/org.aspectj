...
public class PointcutDesignatorHandlerBasedPointcut extends Pointcut {
  ...
  protected FuzzyBoolean matchInternal(Shadow shadow) {
    if (shadow instanceof ReflectionShadow) {
      final MatchingContext context = ((ReflectionShadow) shadow).getMatchingContext();
      final org.aspectj.weaver.tools.FuzzyBoolean match = this.matcher.matchesStatically(context);
