...
public class Lint {
  ...
  public void setFromMap(Map<String, String> lintOptionsMap) {
    for (String key : lintOptionsMap.keySet()) {
      final String value = lintOptionsMap.get(key);
      final Kind kind = kinds.get(key);
      if (kind == null) {
  ...
  public void loadDefaultProperties() {
    final InputStream s = getClass().getResourceAsStream("XlintDefault.properties");
    if (s == null) {
  ...
  public void setFromProperties(Properties properties) {
    for (final Iterator i = properties.entrySet().iterator(); i.hasNext(); ) {
      ...
      final Kind kind = kinds.get(entry.getKey());
      if (kind == null) {
