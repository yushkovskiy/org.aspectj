...
public final class TypeVariableReferenceType extends ReferenceType implements TypeVariableReference {
  ...
  public ReferenceTypeDelegate getDelegate() {
    if (this.delegate == null) {
      final ResolvedType resolvedFirstBound = typeVariable.getFirstBound().resolve(world);
  ...
  public UnresolvedType parameterize(Map<String, UnresolvedType> typeBindings) {
    final UnresolvedType ut = typeBindings.get(getName());
    if (ut != null) {
  ...
  public boolean isAnnotation() {
    final ReferenceType upper = (ReferenceType) typeVariable.getUpperBound();
    if (upper.isAnnotation()) {
      return true;
    }
    final World world = upper.getWorld();
    typeVariable.resolve(world);
    final ResolvedType annotationType = ResolvedType.ANNOTATION.resolve(world);
    final UnresolvedType[] ifBounds = typeVariable.getSuperInterfaces();// AdditionalBounds();
