...
public class NameMangler {
  ...
  public static String adviceName(String nameAsIdentifier, AdviceKind kind, int adviceSeqNumber, int pcdHash) {
    final String newname = makeName(kind.getName(), nameAsIdentifier, Integer.toString(adviceSeqNumber), Integer.toHexString(pcdHash));
    return newname;
  }
  ...
  public static String getExtractableName(Member shadowSignature) {
    final String name = shadowSignature.getName();
    final MemberKind kind = shadowSignature.getKind();
