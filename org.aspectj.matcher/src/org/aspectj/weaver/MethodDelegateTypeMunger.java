...
public class MethodDelegateTypeMunger extends ResolvedTypeMunger {
  ...
  public boolean equals(Object other) {
    ...
    final MethodDelegateTypeMunger o = (MethodDelegateTypeMunger) other;
  ...
  public ResolvedMember getDelegateFactoryMethod(World w) {
    final ResolvedType aspectType = w.resolve(aspect);
    final ResolvedMember[] methods = aspectType.getDeclaredMethods();
    for (int i = 0; i < methods.length; i++) {
      final ResolvedMember rm = methods[i];
  ...
  public static ResolvedTypeMunger readMethod(VersionedDataInputStream s, ISourceContext context, boolean isEnhanced)
      throws IOException {
    final ResolvedMemberImpl signature = ResolvedMemberImpl.readResolvedMember(s, context);
    final UnresolvedType aspect = UnresolvedType.read(s);
    final String implClassName = s.readUTF();
    final TypePattern tp = TypePattern.read(s, context);
    final MethodDelegateTypeMunger typeMunger = new MethodDelegateTypeMunger(signature, aspect, implClassName, tp);
  ...
  public static class FieldHostTypeMunger extends ResolvedTypeMunger {
    ...
    public boolean equals(Object other) {
      ...
      final FieldHostTypeMunger o = (FieldHostTypeMunger) other;
      return ((o.aspect == null) ? (aspect == null) : aspect.equals(o.aspect))
          && ((o.typePattern == null) ? (typePattern == null) : typePattern.equals(o.typePattern));
    }
