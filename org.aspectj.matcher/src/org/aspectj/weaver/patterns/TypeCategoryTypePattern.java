...
public class TypeCategoryTypePattern extends TypePattern {
  ...
  public boolean equals(Object other) {
    ...
    final TypeCategoryTypePattern o = (TypeCategoryTypePattern) other;
  ...
  public static TypePattern read(VersionedDataInputStream s, ISourceContext context) throws IOException {
    final int version = s.readInt();
    final int category = s.readInt();
    final TypeCategoryTypePattern tp = new TypeCategoryTypePattern(category);
