...
public class ThisOrTargetPointcut extends NameBindingPointcut {
  ...
  public Pointcut parameterizeWith(Map typeVariableMap, World w) {
    final ThisOrTargetPointcut ret = new ThisOrTargetPointcut(isThis, typePattern.parameterizeWith(typeVariableMap, w));
  ...
  protected FuzzyBoolean matchInternal(Shadow shadow) {
    ...
    final UnresolvedType typeToMatch = isThis ? shadow.getThisType() : shadow.getTargetType();
  ...
  public static Pointcut read(VersionedDataInputStream s, ISourceContext context) throws IOException {
    ...
    final ThisOrTargetPointcut ret = new ThisOrTargetPointcut(isThis, type);
  ...
  public boolean equals(Object other) {
    ...
    final ThisOrTargetPointcut o = (ThisOrTargetPointcut) other;
  ...
  public Pointcut concretize1(ResolvedType inAspect, ResolvedType declaringType, IntMap bindings) {
    ...
    final TypePattern newType = typePattern.remapAdviceFormals(bindings);
    if (inAspect.crosscuttingMembers != null) {
      inAspect.crosscuttingMembers.exposeType(newType.getExactType());
    }

    final Pointcut ret = new ThisOrTargetPointcut(isThis, newType);
    ret.copyLocationFrom(this);
    return ret;
  }
