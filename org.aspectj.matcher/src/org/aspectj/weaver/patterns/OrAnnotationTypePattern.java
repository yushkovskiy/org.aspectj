...
public class OrAnnotationTypePattern extends AnnotationTypePattern {
  ...
  public AnnotationTypePattern parameterizeWith(Map typeVariableMap, World w) {
    ...
    final OrAnnotationTypePattern ret = new OrAnnotationTypePattern(newLeft, newRight);
  ...
  public static AnnotationTypePattern read(VersionedDataInputStream s, ISourceContext context) throws IOException {
    final AnnotationTypePattern p = new OrAnnotationTypePattern(AnnotationTypePattern.read(s, context), AnnotationTypePattern.read(s,
        context));
  ...
  public boolean equals(Object obj) {
    ...
    final OrAnnotationTypePattern other = (OrAnnotationTypePattern) obj;
