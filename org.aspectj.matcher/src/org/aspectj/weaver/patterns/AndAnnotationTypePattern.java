...
public class AndAnnotationTypePattern extends AnnotationTypePattern {
  ...
  public AnnotationTypePattern parameterizeWith(Map typeVariableMap, World w) {
    final AnnotationTypePattern newLeft = left.parameterizeWith(typeVariableMap, w);
    final AnnotationTypePattern newRight = right.parameterizeWith(typeVariableMap, w);
    final AndAnnotationTypePattern ret = new AndAnnotationTypePattern(newLeft, newRight);
  ...
  public static AnnotationTypePattern read(VersionedDataInputStream s, ISourceContext context) throws IOException {
    final AnnotationTypePattern p = new AndAnnotationTypePattern(AnnotationTypePattern.read(s, context), AnnotationTypePattern.read(
        s, context));
  ...
  public boolean equals(Object obj) {
    ...
    final AndAnnotationTypePattern other = (AndAnnotationTypePattern) obj;
