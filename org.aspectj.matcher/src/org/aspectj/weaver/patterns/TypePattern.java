...
public abstract class TypePattern extends PatternNode {
  ...
  protected boolean matchesSubtypes(ResolvedType type) {
    ...
    for (final Iterator<ResolvedType> i = typesIterator; i.hasNext(); ) {
  ...
  protected boolean matchesSubtypes(ResolvedType superType, ResolvedType annotatedType) {
    ...
    for (final Iterator<ResolvedType> i = superType.getDirectSupertypes(); i.hasNext(); ) {
      final ResolvedType superSuperType = (ResolvedType) i.next();
  ...
  public UnresolvedType resolveExactType(IScope scope, Bindings bindings) {
    final TypePattern p = resolveBindings(scope, bindings, false, true);
