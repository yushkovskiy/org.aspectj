...
public abstract class AbstractSignaturePattern implements ISignaturePattern {
  ...
  public static void writeCompoundSignaturePattern(CompressingDataOutputStream s, ISignaturePattern sigPattern)
    ...
    if (sigPattern instanceof SignaturePattern) {
      ...
      final AndSignaturePattern andSignaturePattern = (AndSignaturePattern) sigPattern;
      s.writeByte(AND);
      ...
      final OrSignaturePattern orSignaturePattern = (OrSignaturePattern) sigPattern;
      s.writeByte(OR);
      ...
      // negated
      final NotSignaturePattern notSignaturePattern = (NotSignaturePattern) sigPattern;
      s.writeByte(NOT);
