...
public class ExactAnnotationFieldTypePattern extends ExactAnnotationTypePattern {
  ...
  public AnnotationTypePattern resolveBindings(IScope scope, Bindings bindings, boolean allowBinding) {
    ...
    resolved = true;
    final FormalBinding formalBinding = scope.lookupFormal(formalName);
    ...
    final ResolvedType formalBindingType = formalBinding.getType().resolve(scope.getWorld());

    final String bindingTypeSignature = formalBindingType.getSignature();
    ...
    final ReferenceType theAnnotationType = (ReferenceType) annotationType;
    final ResolvedMember[] annotationFields = theAnnotationType.getDeclaredMethods();
    field = null;
    boolean looksAmbiguous = false;
    for (int i = 0; i < annotationFields.length; i++) {
      final ResolvedMember resolvedMember = annotationFields[i];
    ...
    final BindingAnnotationFieldTypePattern binding = new BindingAnnotationFieldTypePattern(formalBinding.getType(),
  ...
  public static AnnotationTypePattern read(VersionedDataInputStream s, ISourceContext context) throws IOException {
    final ExactAnnotationFieldTypePattern ret;
    final String formalName = s.readUTF();
    final UnresolvedType annotationType = UnresolvedType.read(s);
  ...
  public boolean equals(Object obj) {
    ...
    final ExactAnnotationFieldTypePattern other = (ExactAnnotationFieldTypePattern) obj;
