...
public class AndTypePattern extends TypePattern {
  ...
  public static TypePattern read(VersionedDataInputStream s, ISourceContext context) throws IOException {
    final AndTypePattern ret = new AndTypePattern(TypePattern.read(s, context), TypePattern.read(s, context));
  ...
  public TypePattern parameterizeWith(Map typeVariableMap, World w) {
    ...
    final AndTypePattern ret = new AndTypePattern(newLeft, newRight);
  ...
  public boolean equals(Object obj) {
    ...
    final AndTypePattern atp = (AndTypePattern) obj;
