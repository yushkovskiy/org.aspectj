...
public class PerTypeWithin extends PerClause {
  ...
  public Pointcut parameterizeWith(Map typeVariableMap, World w) {
    final PerTypeWithin ret = new PerTypeWithin(typePattern.parameterizeWith(typeVariableMap, w));
  ...
  protected FuzzyBoolean matchInternal(Shadow shadow) {
    ...
    if (enclosingType.isMissing()) {
      ...
      final IMessage msg = new Message("Cant find type pertypewithin matching...", shadow.getSourceLocation(), true,
  ...
  protected Test findResidueInternal(Shadow shadow, ExposedState state) {
    ...
    final Expr myInstance = Expr.makeCallExpr(AjcMemberMaker.perTypeWithinLocalAspectOf(shadow.getEnclosingType(), inAspect/*
                                                             * shadow.
																														 * getEnclosingType
																														 * ( )
																														 */),
  ...
  public PerClause concretize(ResolvedType inAspect) {
    final PerTypeWithin ret = new PerTypeWithin(typePattern);
    ret.copyLocationFrom(this);
    ...
    final SignaturePattern sigpat = new SignaturePattern(Member.STATIC_INITIALIZATION, ModifiersPattern.ANY, TypePattern.ANY,
        TypePattern.ANY,// typePattern,
        NamePattern.ANY, TypePatternList.ANY, ThrowsPattern.ANY, AnnotationTypePattern.ANY);

    final Pointcut staticInitStar = new KindedPointcut(Shadow.StaticInitialization, sigpat);
    final Pointcut withinTp = new WithinPointcut(typePattern);
    final Pointcut andPcut = new AndPointcut(staticInitStar, withinTp);
    ...
    final ResolvedTypeMunger munger = new PerTypeWithinTargetTypeMunger(inAspect, ret);
  ...
  public static PerClause readPerClause(VersionedDataInputStream s, ISourceContext context) throws IOException {
    final PerClause ret = new PerTypeWithin(TypePattern.read(s, context));
  ...
  public boolean equals(Object other) {
    ...
    final PerTypeWithin pc = (PerTypeWithin) other;
