...
public class AnnotationPointcut extends NameBindingPointcut {
  ...
  public Pointcut parameterizeWith(Map typeVariableMap, World w) {
    final AnnotationPointcut ret = new AnnotationPointcut((ExactAnnotationTypePattern) annotationTypePattern.parameterizeWith(
        typeVariableMap, w));
  ...
  protected FuzzyBoolean matchInternal(Shadow shadow) {
    ...
    final Shadow.Kind kind = shadow.getKind();
    if (kind == Shadow.StaticInitialization) {
      ...
      if (rMember.isAnnotatedElsewhere()) {
        if (kind == Shadow.FieldGet || kind == Shadow.FieldSet) {
          ...
          final List mungers = rMember.getDeclaringType().resolve(shadow.getIWorld()).getInterTypeMungers();
          for (final Iterator iter = mungers.iterator(); iter.hasNext(); ) {
            final ConcreteTypeMunger typeMunger = (ConcreteTypeMunger) iter.next();
  ...
  protected Pointcut concretize1(ResolvedType inAspect, ResolvedType declaringType, IntMap bindings) {
    ...
    final Pointcut ret = new AnnotationPointcut(newType, bindings.getEnclosingAdvice());
    ret.copyLocationFrom(this);
    return ret;
  }
  ...
  protected Test findResidueInternal(Shadow shadow, ExposedState state) {
    if (annotationTypePattern instanceof BindingAnnotationFieldTypePattern) {
      ...
      final BindingAnnotationFieldTypePattern btp = (BindingAnnotationFieldTypePattern) annotationTypePattern;
      final ResolvedType formalType = btp.getFormalType().resolve(shadow.getIWorld());
      final UnresolvedType annoType = btp.getAnnotationType();
      ...
      final Var var = shadow.getKindedAnnotationVar(annoType);
      if (var == null) {
      ...
      final UnresolvedType annotationType = btp.getAnnotationType();
      final Var var = shadow.getKindedAnnotationVar(annotationType);
  ...
  public static Pointcut read(VersionedDataInputStream s, ISourceContext context) throws IOException {
    ...
    final AnnotationPointcut ret = new AnnotationPointcut((ExactAnnotationTypePattern) type);
  ...
  public boolean equals(Object other) {
    ...
    final AnnotationPointcut o = (AnnotationPointcut) other;
