...
public class ThisOrTargetAnnotationPointcut extends NameBindingPointcut {
  ...
  public Pointcut parameterizeWith(Map typeVariableMap, World w) {
    final ExactAnnotationTypePattern newPattern = (ExactAnnotationTypePattern) this.annotationTypePattern.parameterizeWith(
        typeVariableMap, w);
    if (newPattern.getAnnotationType() instanceof ResolvedType) {
      verifyRuntimeRetention(newPattern.getResolvedAnnotationType());
    }
    final ThisOrTargetAnnotationPointcut ret = new ThisOrTargetAnnotationPointcut(isThis,
  ...
  protected FuzzyBoolean matchInternal(Shadow shadow) {
    ...
    final ResolvedType toMatchAgainst = (isThis ? shadow.getThisType() : shadow.getTargetType()).resolve(shadow.getIWorld());
  ...
  protected void resolveBindings(IScope scope, Bindings bindings) {
    ...
    final ResolvedType rAnnotationType = (ResolvedType) annotationTypePattern.annotationType;
  ...
  protected Pointcut concretize1(ResolvedType inAspect, ResolvedType declaringType, IntMap bindings) {
    ...
    final ThisOrTargetAnnotationPointcut ret = new ThisOrTargetAnnotationPointcut(isThis, newType, bindings.getEnclosingAdvice());
  ...
  protected Test findResidueInternal(Shadow shadow, ExposedState state) {
    ...
    final boolean alwaysMatches = match(shadow).alwaysTrue();
    final Var var = isThis ? shadow.getThisVar() : shadow.getTargetVar();
    Var annVar = null;
    ...
    if (alwaysMatches && (annVar == null)) {// change check to verify if its the 'generic' annVar that is being used
      ...
      final ResolvedType rType = annotationType.resolve(shadow.getIWorld());
  ...
  public static Pointcut read(VersionedDataInputStream s, ISourceContext context) throws IOException {
    final boolean isThis = s.readBoolean();
    final AnnotationTypePattern type = AnnotationTypePattern.read(s, context);
    final ThisOrTargetAnnotationPointcut ret = new ThisOrTargetAnnotationPointcut(isThis, (ExactAnnotationTypePattern) type);
  ...
  public boolean equals(Object obj) {
    ...
    final ThisOrTargetAnnotationPointcut other = (ThisOrTargetAnnotationPointcut) obj;
