...
public class DeclareSoft extends Declare {
  ...
  public Declare parameterizeWith(Map typeVariableBindingMap, World w) {
    final DeclareSoft ret = new DeclareSoft(exception.parameterizeWith(typeVariableBindingMap, w), pointcut.parameterizeWith(
  ...
  public boolean equals(Object other) {
    ...
    final DeclareSoft o = (DeclareSoft) other;
  ...
  public static Declare read(VersionedDataInputStream s, ISourceContext context) throws IOException {
    final Declare ret = new DeclareSoft(TypePattern.read(s, context), Pointcut.read(s, context));
  ...
  public void resolve(IScope scope) {
    ...
    if (!excType.isMissing()) {
      if (excType.isTypeVariableReference()) {
        final TypeVariableReferenceType typeVariableRT = (TypeVariableReferenceType) excType;
