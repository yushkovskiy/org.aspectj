...
public class NotTypePattern extends TypePattern {
  ...
  public static TypePattern read(VersionedDataInputStream s, ISourceContext context) throws IOException {
    final TypePattern ret = new NotTypePattern(TypePattern.read(s, context));
  ...
  public TypePattern parameterizeWith(Map typeVariableMap, World w) {
    final TypePattern newNegatedPattern = negatedPattern.parameterizeWith(typeVariableMap, w);
    final NotTypePattern ret = new NotTypePattern(newNegatedPattern);
