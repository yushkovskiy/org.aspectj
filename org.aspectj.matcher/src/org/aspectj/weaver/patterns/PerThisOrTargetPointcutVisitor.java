...
public class PerThisOrTargetPointcutVisitor extends AbstractPatternNodeVisitor {
  ...
  public TypePattern getPerTypePointcut(Pointcut perClausePointcut) {
    final Object o = perClausePointcut.accept(this, perClausePointcut);
  ...
  public Object visit(KindedPointcut node, Object data) {
    if (node.getKind().equals(Shadow.AdviceExecution)) {
      ...
      final SignaturePattern signaturePattern = node.getSignature();
      final boolean isStarAnnotation = signaturePattern.isStarAnnotation();
  ...
  public Object visit(ThisOrTargetPointcut node, Object data) {
    if ((m_isTarget && !node.isThis()) || (!m_isTarget && node.isThis())) {
      final String pointcutString = node.getType().toString();
      ...
      final TypePattern copy = new PatternParser(pointcutString.replace('$', '.')).parseTypePattern();
  ...
  public Object visit(ReferencePointcut node, Object data) {
    ...
    final ResolvedPointcutDefinition pointcutDec;
