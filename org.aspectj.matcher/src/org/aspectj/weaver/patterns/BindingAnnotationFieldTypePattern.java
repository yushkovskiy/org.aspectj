...
public class BindingAnnotationFieldTypePattern extends ExactAnnotationTypePattern implements BindingPattern {
  ...
  public void resolveBinding(World world) {
    ...
    final ResolvedType annoType = (ResolvedType) annotationType;
    if (!annoType.isAnnotation()) {
      final IMessage m = MessageUtil
  ...
  public boolean equals(Object obj) {
    ...
    final BindingAnnotationFieldTypePattern btp = (BindingAnnotationFieldTypePattern) obj;
  ...
  public AnnotationTypePattern remapAdviceFormals(IntMap bindings) {
    if (!bindings.hasKey(formalIndex)) {
      ...
      final BindingAnnotationFieldTypePattern baftp = new BindingAnnotationFieldTypePattern(formalType, newFormalIndex,
          annotationType);
  ...
  public static AnnotationTypePattern read(VersionedDataInputStream s, ISourceContext context) throws IOException {
    final AnnotationTypePattern ret = new BindingAnnotationFieldTypePattern(UnresolvedType.read(s), s.readShort(),
  ...
  public static AnnotationTypePattern read2(VersionedDataInputStream s, ISourceContext context) throws IOException {
    final BindingAnnotationFieldTypePattern ret = new BindingAnnotationFieldTypePattern(UnresolvedType.read(s), s.readShort(),
        UnresolvedType.read(s));
