...
public class AnyWithAnnotationTypePattern extends TypePattern {
  ...
  public TypePattern parameterizeWith(Map typeVariableMap, World w) {
    final AnyWithAnnotationTypePattern ret = new AnyWithAnnotationTypePattern(this.annotationPattern.parameterizeWith(
        typeVariableMap, w));
  ...
  public static TypePattern read(VersionedDataInputStream s, ISourceContext c) throws IOException {
    final AnnotationTypePattern annPatt = AnnotationTypePattern.read(s, c);
    final AnyWithAnnotationTypePattern ret = new AnyWithAnnotationTypePattern(annPatt);
  ...
  public boolean equals(Object obj) {
    ...
    final AnyWithAnnotationTypePattern awatp = (AnyWithAnnotationTypePattern) obj;
