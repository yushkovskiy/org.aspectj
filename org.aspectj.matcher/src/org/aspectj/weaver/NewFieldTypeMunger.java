...
public class NewFieldTypeMunger extends ResolvedTypeMunger {
  ...
  public static ResolvedTypeMunger readField(VersionedDataInputStream s, ISourceContext context) throws IOException {
    ...
    final ResolvedMember fieldSignature = ResolvedMemberImpl.readResolvedMember(s, context);
    final Set superMethodsCalled = readSuperMethodsCalled(s);
    sloc = readSourceLocation(s);
    final List aliases = readInTypeAliases(s);
    final NewFieldTypeMunger munger = new NewFieldTypeMunger(fieldSignature, superMethodsCalled, aliases);
    if (sloc != null) {
  ...
  public ResolvedTypeMunger parameterizedFor(ResolvedType target) {
    ...
    final NewFieldTypeMunger nftm = new NewFieldTypeMunger(parameterizedSignature, getSuperMethodsCalled(), typeVariableAliases);
  ...
  public boolean equals(Object other) {
    ...
    final NewFieldTypeMunger o = (NewFieldTypeMunger) other;
