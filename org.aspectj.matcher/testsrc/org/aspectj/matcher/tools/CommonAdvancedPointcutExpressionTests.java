...
public abstract class CommonAdvancedPointcutExpressionTests extends TestCase {
  ...
  public void testTypeLevelAnnotationMatchingWithStaticInitialization01() {
    final StandardPointcutExpression ex = pointcutParser.parsePointcutExpression("staticinitialization(@testdata.SomeAnnotation *)");
    final ResolvedType jlString = world.resolve("java.lang.String");
    final ResolvedType tAnnotatedClass = world.resolve("testdata.AnnotatedClass");
  ...
  public void testTypeLevelAnnotationMatchingWithExecution01() {
    final StandardPointcutExpression ex = pointcutParser.parsePointcutExpression("execution(* (@testdata.SomeAnnotation *).*(..))");
    final ResolvedType jlString = world.resolve("java.lang.String");
    final ResolvedType tAnnotatedClass = world.resolve("testdata.AnnotatedClass");
  ...
  public void testMethodLevelAnnotationMatchingWithExecution01() {
    final StandardPointcutExpression ex = pointcutParser
