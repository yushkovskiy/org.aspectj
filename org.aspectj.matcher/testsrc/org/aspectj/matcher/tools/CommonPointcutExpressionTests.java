...
public abstract class CommonPointcutExpressionTests extends TestCase {
  ...
  public void testResolveTypeAndRetrieveMethod() {
    final ResolvedType type = world.resolve("java.lang.String");
    assertNotNull(type);
    final ResolvedMember method = getMethod(type, "valueOf", "(Z)Ljava/lang/String;"); // grab the method 'String valueOf()'
  ...
  public void testConstructorExecutionMatching03() {
    ...
    final ResolvedType jlArrayList = world.resolve("java.util.ArrayList");
    final ResolvedType juList = world.resolve("java.util.List");
  ...
  public void testMatchingThis01() {
    ...
    final ResolvedType jlString = world.resolve("java.lang.String");
    final ResolvedType juList = world.resolve("java.util.List");
  ...
  public void testMatchingArgs01() {
    ...
    final ResolvedMember stringSplitMethod = getMethod(jlString, "split", "(Ljava/lang/String;I)[Ljava/lang/String;");
    final ResolvedMember stringValueOfIntMethod = getMethod(jlString, "valueOf", "(I)Ljava/lang/String;");
    final ResolvedMember stringValueOfLongMethod = getMethod(jlString, "valueOf", "(J)Ljava/lang/String;");
  ...
  public void testMatchingWithin01() {
    final StandardPointcutExpression ex = pointcutParser.parsePointcutExpression("within(java.lang.String)");
    final ResolvedType jlString = world.resolve("java.lang.String");
    final ResolvedType juList = world.resolve("java.util.List");

    final ResolvedMember stringSplitMethod = getMethod(jlString, "split", "(Ljava/lang/String;I)[Ljava/lang/String;");
    final ResolvedMember stringValueOfIntMethod = getMethod(jlString, "valueOf", "(I)Ljava/lang/String;");
    final ResolvedMember listAddMethod = getMethod(juList, "add", "(Ljava/lang/Object;)Z");
  ...
  public void testMatchingWithinCode01() {
    final StandardPointcutExpression ex = pointcutParser.parsePointcutExpression("withincode(* *..String.*(..))");
    final ResolvedType jlString = world.resolve("java.lang.String");
    final ResolvedType juList = world.resolve("java.util.List");
  ...
  public void testCall() {
    final StandardPointcutExpression ex = pointcutParser.parsePointcutExpression("call(* *..A.a*(..))");
  ...
  public void testCallAndThisMatchesMethodCall() {
    final StandardPointcutExpression ex = pointcutParser.parsePointcutExpression("call(* *(..)) && this(java.util.ArrayList)");
    final ResolvedType jlString = world.resolve("java.lang.String");
    final ResolvedType juList = world.resolve("java.util.List");
  ...
  public void testMethodMatchesStaticInitialization01() {
    final StandardPointcutExpression ex = pointcutParser.parsePointcutExpression("staticinitialization(java.lang.String)");
    assertNotNull(ex);

    final ResolvedType jlString = world.resolve("java.lang.String");

    final boolean b = ex.matchesStaticInitialization(jlString).alwaysMatches();
    assertTrue(b);
  }
  ...
  public void testMethodMatchesStaticInitialization03() {
    final ResolvedType juArrayList = world.resolve("java.util.ArrayList");
    StandardPointcutExpression ex = pointcutParser.parsePointcutExpression("staticinitialization(java..*)");
  ...
  private void checkAlwaysMatches(String pointcutExpression, String type, String methodName, String methodSignature) {
    final StandardPointcutExpression ex = pointcutParser.parsePointcutExpression(pointcutExpression);
    assertNotNull(ex);
    final ResolvedType resolvedType = world.resolve(type);
    final ResolvedMember method = getMethod(resolvedType, methodName, methodSignature);
    assertNotNull("Couldn't find a method with signature " + methodSignature, method);
    final boolean b = ex.matchesMethodExecution(method).alwaysMatches();
  ...
  private void checkNeverMatches(String pointcutExpression, String type, String methodName, String methodSignature) {
    ...
    final ResolvedMember method = getMethod(resolvedType, methodName, methodSignature);
    assertNotNull(method);
    final boolean b = ex.matchesMethodExecution(method).neverMatches();
    assertTrue(b);
  }
}
