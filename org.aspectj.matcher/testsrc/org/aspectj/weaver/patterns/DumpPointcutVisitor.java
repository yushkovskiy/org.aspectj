...
public class DumpPointcutVisitor implements PatternNodeVisitor {
  ...
  public Object visit(AnnotationPatternList node, Object data) {
    final AnnotationTypePattern[] annotations = node.getAnnotationPatterns();
  ...
  public Object visit(TypePatternList node, Object data) {
    ...
    final TypePattern[] typePatterns = node.getTypePatterns();
    for (int i = 0; i < typePatterns.length; i++) {
      final TypePattern typePattern = typePatterns[i];
      if (i > 0) {
        append(", ");
      }
  ...
  public Object visit(WildTypePattern node, Object data) {
    ...
    final NamePattern[] namePatterns = node.getNamePatterns();
  ...
  public static void check(PatternNode pc, boolean isTypePattern) {
    final DumpPointcutVisitor v1 = new DumpPointcutVisitor();
    pc.accept(v1, null);

    final DumpPointcutVisitor v2 = new DumpPointcutVisitor();
