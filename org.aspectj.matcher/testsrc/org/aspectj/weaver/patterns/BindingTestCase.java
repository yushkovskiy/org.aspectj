...
public class BindingTestCase extends PatternsTestCase {
  ...
  public void testResolveBindings() {
    final BindingTypePattern at = new BindingTypePattern(world.resolve("java.lang.Object"), 0, false);
    final BindingTypePattern bt = new BindingTypePattern(world.resolve("java.lang.Object"), 1, false);

    final BindingTypePattern[] all = new BindingTypePattern[]{at, bt};
    final BindingTypePattern[] none = new BindingTypePattern[]{null, null};
    final BindingTypePattern[] a = new BindingTypePattern[]{at, null};
    final BindingTypePattern[] b = new BindingTypePattern[]{null, bt};
  ...
  private void checkBindingFailure(String pattern, String prefix) {
    ...
    final Bindings actualBindings = new Bindings(2);
    try {
  ...
  private void checkBindings(String pattern, BindingTypePattern[] expectedBindings) {
    final PatternParser parser = new PatternParser(pattern);
    final Pointcut p = parser.parsePointcut();
    final Bindings actualBindings = new Bindings(expectedBindings.length);

    final TestScope simpleScope = makeSimpleScope();
