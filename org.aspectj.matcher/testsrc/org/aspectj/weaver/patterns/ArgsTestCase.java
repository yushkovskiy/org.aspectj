...
public class ArgsTestCase extends TestCase {
  ...
  public void testMatchJP() throws Exception {
    ...
    final Method oneAArg = B.class.getMethod("x", new Class[]{A.class});
    final Method oneBArg = B.class.getMethod("y", new Class[]{B.class});
    final Method acArgs = C.class.getMethod("z", new Class[]{A.class, C.class});
    final Method baArgs = C.class.getMethod("t", new Class[]{B.class, A.class});
  ...
  public void testBinding() throws Exception {
    ...
    final PointcutParameter a = parser.createPointcutParameter("a", A.class);
    final A theParameter = new A();
    final PointcutExpression bindA = parser.parsePointcutExpression("args(a,*)", A.class, new PointcutParameter[]{a});
    ...
    final PointcutParameter c = parser.createPointcutParameter("c", C.class);
    final C cParameter = new C();
    final PointcutExpression bindAandC = parser.parsePointcutExpression("args(a,c)", A.class, new PointcutParameter[]{a, c});
  ...
  public void testMatchJPWithPrimitiveTypes() throws Exception {
    ...
    try {
      ...
      final PointcutParser parser = PointcutParser
          .getPointcutParserSupportingAllPrimitivesAndUsingSpecifiedClassloaderForResolution(A.class.getClassLoader());
      final PointcutExpression oneInt = parser.parsePointcutExpression("args(int)");
      final PointcutExpression oneInteger = parser.parsePointcutExpression("args(Integer)");

      final Method oneIntM = A.class.getMethod("anInt", new Class[]{int.class});
      final Method oneIntegerM = A.class.getMethod("anInteger", new Class[]{Integer.class});
  ...
  private static void checkMatches(ShadowMatch sMatch, Object thisOjb, Object targetObj, Object[] args) {
    assertTrue("match expected", sMatch.matchesJoinPoint(thisOjb, targetObj, args).matches());
  }

  private static void checkNoMatch(ShadowMatch sMatch, Object thisOjb, Object targetObj, Object[] args) {
