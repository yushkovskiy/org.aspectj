...
public class TestUtils {
  ...
  public static MemberImpl fieldFromString(String str) {
    ...
    while (!Character.isWhitespace(str.charAt(i)))
      i++;
    final UnresolvedType retTy = UnresolvedType.forName(str.substring(start, i));

    start = i;
    i = str.lastIndexOf('.');
    final UnresolvedType declaringTy = UnresolvedType.forName(str.substring(start, i).trim());
    start = ++i;
    final String name = str.substring(start, len).trim();
  ...
  public static Member methodFromString(String str) {
    ...
    while (!Character.isWhitespace(str.charAt(i)))
      i++;
    final UnresolvedType returnTy = UnresolvedType.forName(str.substring(start, i));
    ...
    start = ++i;
    i = str.indexOf('(', i);
    final String name = str.substring(start, i).trim();
    start = ++i;
    i = str.indexOf(')', i);

    final String[] paramTypeNames = parseIds(str.substring(start, i).trim());
