...
public interface IMessageHandler {
   ...
   */
  boolean handleMessage(@NotNull IMessage message) throws AbortException;
   ...
   */
  boolean isIgnoring(@Nullable IMessage.Kind kind);
   ...
   * @param kind
   */
  void dontIgnore(@Nullable IMessage.Kind kind);
   ...
   * @param kind
   */
  void ignore(@Nullable IMessage.Kind kind);
}
