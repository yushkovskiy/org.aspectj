...
public interface IMessageHolder extends IMessageHandler { // XXX do not extend - mix instead
   ...
   */
  boolean hasAnyMessage(@Nullable IMessage.Kind kind, boolean orGreater);
   ...
   */
  int numMessages(@Nullable IMessage.Kind kind, boolean orGreater);
   ...
   */
  @NotNull
  IMessage[] getMessages(@Nullable IMessage.Kind kind, boolean orGreater);
