...
public class MessageHandler implements IMessageHolder {
  ...
  public void init(boolean accumulateOnly) {
    ...
    if (0 < ignoring.size()) {
      final boolean ignoringWeaveMessages = isIgnoring(IMessage.WEAVEINFO);
      ignoring.clear();
   ...
   * @see org.aspectj.bridge.IMessageHandler#isIgnoring(IMessage.Kind)
   */
  @Override
  public boolean isIgnoring(@Nullable IMessage.Kind kind) {
   ...
   */
  @Override
  public void ignore(@Nullable IMessage.Kind kind) { // XXX sync
   ...
   */
  @Override
  public void dontIgnore(@Nullable IMessage.Kind kind) {
    if (null != kind) {
  ...
  /**
   * @see org.aspectj.bridge.IMessageHolder#hasAnyMessage(IMessage.Kind, boolean)
   */
  @Override
  public boolean hasAnyMessage(@Nullable final IMessage.Kind kind, final boolean orGreater) {
    if (null == kind) {
   ...
   */
  @Override
  public int numMessages(@Nullable IMessage.Kind kind, final boolean orGreater) {
    if (null == kind) {
  ...
  @Override
  @NotNull
  public IMessage[] getMessages(@Nullable IMessage.Kind kind, final boolean orGreater) {
    if (null == kind) {
   ...
   */
  public void setInterceptor(@Nullable IMessageHandler interceptor) {
