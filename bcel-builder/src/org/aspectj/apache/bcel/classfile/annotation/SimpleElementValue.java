...
public class SimpleElementValue extends ElementValue {
  ...
  public byte getValueByte() {
    ...
    final ConstantInteger c = (ConstantInteger) cpool.getConstant(idx, Constants.CONSTANT_Integer);
  ...
  public long getValueLong() {
    ...
    final ConstantLong j = (ConstantLong) cpool.getConstant(idx);
    return j.getValue();
  }
  ...
  public float getValueFloat() {
    ...
    final ConstantFloat f = (ConstantFloat) cpool.getConstant(idx);
    return f.getValue();
  }
  ...
  public double getValueDouble() {
    ...
    final ConstantDouble d = (ConstantDouble) cpool.getConstant(idx);
    return d.getValue();
  }
  ...
  public boolean getValueBoolean() {
    ...
    final ConstantInteger bo = (ConstantInteger) cpool.getConstant(idx);
  ...
  public short getValueShort() {
    ...
    final ConstantInteger s = (ConstantInteger) cpool.getConstant(idx);
  ...
  public String getValueString() {
    ...
    final ConstantUtf8 c = (ConstantUtf8) cpool.getConstant(idx);
    return c.getValue();
  }
  ...
  public int getValueInt() {
    ...
    final ConstantInteger c = (ConstantInteger) cpool.getConstant(idx);
    return c.getValue();
  }
  ...
  public String stringifyValue() {
    switch (type) {
      ...
      case PRIMITIVE_BYTE:
        final ConstantInteger b = (ConstantInteger) cpool.getConstant(idx);
        return Integer.toString(b.getValue());
      case PRIMITIVE_CHAR:
        final ConstantInteger ch = (ConstantInteger) cpool.getConstant(idx);
      ...
      case STRING:
        final ConstantUtf8 cu8 = (ConstantUtf8) cpool.getConstant(idx);
        return cu8.getValue();
  ...
  public String toString() {
    ...
    switch (type) {
      ...
      case PRIMITIVE_FLOAT:
        ...
        break;
      case PRIMITIVE_SHORT:
        final ConstantInteger ci = (ConstantInteger) cpool.getConstant(idx);
