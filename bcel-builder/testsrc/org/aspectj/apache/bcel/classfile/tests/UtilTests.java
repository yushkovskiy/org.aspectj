...
public class UtilTests extends TestCase {
  ...
  public void testUtilityClassSignatureManipulation1() {
    final String[] ss = UtilTests.methodSignatureArgumentTypes("(Ljava/lang/String;I[Ljava/lang/Integer;)");
  ...
  public void testUtilityClassSignatureManipulation2() {
    final String s = Utility.methodSignatureToString("(Ljava/lang/String;[Z[[Ljava/lang/Integer;II)Z", "hello", "public");
    final String expected = "public boolean hello(String arg1, boolean[] arg2, Integer[][] arg3, int arg4, int arg5)";
    assertTrue("Expected '" + expected + "' but got " + s, s.equals(expected));
  }

  public void testTypeUtilMethods1() {
    final String s = Utility.toMethodSignature(Type.DOUBLE, new Type[]{Type.INT, Type.STRING, Type.SHORT});
