...
public class MethodParametersTest extends BcelTestCase {
  ...
  public void testMethodParameters1() throws Exception {
    final JavaClass jc = getClassFromJava8Jar("Parameters");
    final Method m = getMethod(jc, "foo");
    final MethodParameters mp = (MethodParameters) getAttribute(m.getAttributes(), Constants.ATTR_METHOD_PARAMETERS);
  ...
  public void testMethodParameters2() throws Exception {
    final JavaClass jc = getClassFromJava8Jar("Parameters");
    final Method m = getMethod(jc, "bar");
    final MethodParameters mp = (MethodParameters) getAttribute(m.getAttributes(), Constants.ATTR_METHOD_PARAMETERS);
  ...
  public void testMethodParameters3() throws Exception {
    final JavaClass jc = getClassFromJava8Jar("Parameters$Inner");
    final Method m = getMethod(jc, "<init>");
    final MethodParameters mp = (MethodParameters) getAttribute(m.getAttributes(), Constants.ATTR_METHOD_PARAMETERS);
  ...
  public void testMethodParameters4() throws Exception {
    final JavaClass jc = getClassFromJava8Jar("Parameters$Color");
    final Method m = getMethod(jc, "<init>");
    final MethodParameters mp = (MethodParameters) getAttribute(m.getAttributes(), Constants.ATTR_METHOD_PARAMETERS);
    assertEquals(2, mp.getParametersCount());
