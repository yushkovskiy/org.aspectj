...
public class ElementValueGenTest extends BcelTestCase {
  ...
  public void testCreateIntegerElementValue() {
    ...
    final SimpleElementValue evg = new SimpleElementValue(ElementValue.PRIMITIVE_INT, cp, 555);
  ...
  public void testCreateFloatElementValue() {
    ...
    final SimpleElementValue evg = new SimpleElementValue(ElementValue.PRIMITIVE_FLOAT, cp, 111.222f);
    // Creation of an element like that should leave a new entry in the cpool
  ...
  public void testCreateDoubleElementValue() {
    ...
    final SimpleElementValue evg = new SimpleElementValue(ElementValue.PRIMITIVE_DOUBLE, cp, 333.44);
    // Creation of an element like that should leave a new entry in the cpool
  ...
  public void testCreateLongElementValue() {
    ...
    final SimpleElementValue evg = new SimpleElementValue(ElementValue.PRIMITIVE_LONG, cp, 3334455L);
    // Creation of an element like that should leave a new entry in the cpool
  ...
  public void testCreateCharElementValue() {
    ...
    final SimpleElementValue evg = new SimpleElementValue(ElementValue.PRIMITIVE_CHAR, cp, (char) 't');
    // Creation of an element like that should leave a new entry in the cpool
    final int idx = cp.lookupInteger((char) 't');
    assertTrue("Should have the same index in the constantpool but " + evg.getIndex() + "!=" + idx, evg.getIndex() == idx);
    checkSerialize(evg, cp);
  }
  ...
  public void testCreateByteElementValue() {
    ...
    final SimpleElementValue evg = new SimpleElementValue(ElementValue.PRIMITIVE_CHAR, cp, (byte) 'z');
    // Creation of an element like that should leave a new entry in the cpool
  ...
  public void testCreateBooleanElementValue() {
    ...
    final SimpleElementValue evg = new SimpleElementValue(ElementValue.PRIMITIVE_BOOLEAN, cp, true);
    // Creation of an element like that should leave a new entry in the cpool
  ...
  public void testCreateShortElementValue() {
    ...
    final SimpleElementValue evg = new SimpleElementValue(ElementValue.PRIMITIVE_SHORT, cp, (short) 42);
    // Creation of an element like that should leave a new entry in the cpool
  ...
  public void testCreateStringElementValue() {
    ...
    final SimpleElementValue evg = new SimpleElementValue(ElementValue.STRING, cp, "hello");
    // Creation of an element like that should leave a new entry in the cpool
  ...
  public void testCreateEnumElementValue() {
    ...
    final EnumElementValue evg = new EnumElementValue(enumType, "Red", cp);
    // Creation of an element like that should leave a new entry in the cpool
  ...
  public void testCreateMarkerAnnotationElementValue() {
    final ClassGen cg = createClassGen("HelloWorld");
    final ConstantPool cp = cg.getConstantPool();
    final ObjectType annoType = new ObjectType("SimpleMarkerAnnotation");
    final AnnotationGen annoGen = new AnnotationGen(annoType, Collections.<NameValuePair>emptyList(), true, cp);
    final AnnotationElementValue evg = new AnnotationElementValue(annoGen, cp);
    checkSerialize(evg, cp);
  }
  ...
  public void testCreateClassElementValue() {
    ...
    final ClassElementValue evg = new ClassElementValue(classType, cp);
  ...
  private static void checkSerialize(ElementValue evgBefore, ConstantPool cpg) {
    try {
      ...
      final ElementValue evgAfter = ElementValue.readElementValue(dis, cpg);
