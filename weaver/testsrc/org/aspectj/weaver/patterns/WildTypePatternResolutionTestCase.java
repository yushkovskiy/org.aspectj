...
public class WildTypePatternResolutionTestCase extends TestCase {
  ...
  public void testSimpleFoo() {
    final TypePattern rtp = resolveWildTypePattern("List", false);
    ...
    final ExactTypePattern etp = (ExactTypePattern) writeAndRead(rtp);
  ...
  public void testParameterized() {
    final TypePattern rtp = resolveWildTypePattern("List<String>", false);
  ...
  public void testParameterizedWildCard() {
    final TypePattern rtp = resolveWildTypePattern("List<Str*>", false);
    ...
    final WildTypePattern wtp = (WildTypePattern) writeAndRead(rtp);
  ...
  public void testWildcardParameterized() {
    final TypePattern rtp = resolveWildTypePattern("Li*<String>", false);
  ...
  public void testSomethingExtends() {
    final TypePattern rtp = resolveWildTypePattern("List<? extends Number>", false);
    ...
    final ResolvedType listOfNumber = TypeFactory.createParameterizedType(javaUtilList, new UnresolvedType[]{UnresolvedType
        .forName("java.lang.Number").resolve(world)}, world);

    final ResolvedType listOfDouble = TypeFactory.createParameterizedType(javaUtilList, new UnresolvedType[]{UnresolvedType
    ...
    final ResolvedType extendsNumber = TypeFactory.createTypeFromSignature("+Ljava/lang/Number;").resolve(world);
    final ResolvedType listOfExtendsNumber = TypeFactory.createParameterizedType(javaUtilList,
  ...
  public void testSomethingExtendsPattern() {
    ...
    final ResolvedType extendsDouble = TypeFactory.createTypeFromSignature("+Ljava/lang/Double;").resolve(world);
    final ResolvedType listOfExtendsDouble = TypeFactory.createParameterizedType(javaUtilList,
  ...
  public void testSomethingExtendsPatternv2() {
    final TypePattern rtp = resolveWildTypePattern("List<? extends Num*>", false);
    ...
    final boolean matchesListOfNumber = wtp.matches(listOfNumber, TypePattern.STATIC).alwaysTrue();
    ...
    final boolean matchesListOfQmarkExtendsNumber = wtp.matches(listOfExtendsNumber, TypePattern.STATIC).alwaysTrue();
  ...
  public void testSomethingSuper() {
    final TypePattern rtp = resolveWildTypePattern("List<? super Double>", false);
    ...
    final ResolvedType superDouble = TypeFactory.createTypeFromSignature("-Ljava/lang/Double;").resolve(world);
    final ResolvedType listOfSuperDouble = TypeFactory.createParameterizedType(javaUtilList, new UnresolvedType[]{superDouble},
        world);
  ...
  private TypePattern writeAndRead(TypePattern etp) {
    try {
      ...
      final CompressingDataOutputStream dos = new CompressingDataOutputStream(baos, cps);
      etp.write(dos);
      dos.flush();
      dos.close();
      final ByteArrayInputStream bais = new ByteArrayInputStream(baos.toByteArray());
      final VersionedDataInputStream in = new VersionedDataInputStream(bais, cps);
      in.setVersion(new WeaverVersionInfo());
      final TypePattern ret = TypePattern.read(in, null);
      return ret;
