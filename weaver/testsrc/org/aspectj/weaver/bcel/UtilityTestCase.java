...
public class UtilityTestCase extends TestCase {
  ...
  public void disassembleTest(String name) throws IOException {
    final BcelWorld world = new BcelWorld("../weaver/bin");
//        world.setFastDelegateSupport(false);
    world.addPath(WeaveTestCase.classDir);

    final LazyClassGen clazz = new LazyClassGen(BcelWorld.getBcelObjectType(world.resolve(name)));
    clazz.print();
    System.out.println();
  }
...
//    }
  ...
  public static void main(String[] args) throws IOException {
    ...
    final LazyClassGen clazz = new LazyClassGen(BcelWorld.getBcelObjectType(world.resolve(args[0])));
    clazz.print();
  }
}
