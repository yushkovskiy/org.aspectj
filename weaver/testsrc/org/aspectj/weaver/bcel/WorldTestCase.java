...
public class WorldTestCase extends CommonWorldTests {
  ...
  public void xtestTraceJar() {
    final ResolvedType trace = world.resolve(UnresolvedType.forName("Trace"), true);
    assertTrue("Couldnt find type Trace", !trace.isMissing());
    fieldsTest(trace, Member.NONE);
    /* Member constr = */
    TestUtils.methodFromString("void Trace.<init>()");
    ...
    final ResolvedType myTrace = world.resolve(UnresolvedType.forName("MyTrace"), true);
  ...
  public void testIterator() {
    final int abstractPublic = Modifier.ABSTRACT | Modifier.PUBLIC;
    final ResolvedType iter = world.getCoreType(UnresolvedType.forRawTypeName("java.util.Iterator"));
    ...
    final ResolvedMember remove = iter.lookupMethod(MemberImpl.method(iter, 0, "remove", "()V"));
    ...
    final ResolvedMember clone = iter.lookupMethod(MemberImpl.method(UnresolvedType.OBJECT, 0, "clone", "()Ljava/lang/Object;"));
