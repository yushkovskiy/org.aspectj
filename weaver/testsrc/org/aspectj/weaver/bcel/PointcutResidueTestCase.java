...
public class PointcutResidueTestCase extends WeaveTestCase {
  ...
  private void checkWeave(String label, String filename, String pointcutSource, String[] formalTypes, String[] formalNames)
    ...
    final ShadowMunger pp = new BcelAdvice(AdviceKind.Before, rp, MemberImpl.method(UnresolvedType.forName("Aspect"),
    ...
    final ResolvedType inAspect = world.resolve("Aspect");
    final CrosscuttingMembers xcut = new CrosscuttingMembers(inAspect, true);
    inAspect.crosscuttingMembers = xcut;

    final ShadowMunger cp = pp.concretize(inAspect, world, null);
