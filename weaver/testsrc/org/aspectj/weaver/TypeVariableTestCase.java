...
public class TypeVariableTestCase extends TestCase {
  ...
  public void testDefaultBounds() {
    final TypeVariable typevariable = new TypeVariable("T");
  ...
  public void testName() {
    final TypeVariable tv = new TypeVariable("T");
    assertEquals("T", tv.getName());
  }

  public void testUpperBound() {
    final TypeVariable tv = new TypeVariable("N", javaLangNumber);
    assertEquals("java.lang.Number", javaLangNumber, tv.getUpperBound());
  }

  public void testAdditionalUpperBounds() {
    final TypeVariable tv = new TypeVariable("E", UnresolvedType.OBJECT, new UnresolvedType[]{javaUtilList});
  ...
  public void testResolution() {
    final TypeVariable tv = new TypeVariable("T", javaLangNumber, new UnresolvedType[]{javaUtilList});
    tv.resolve(world);
  ...
  public void testBindWithoutResolve() {
    final TypeVariable tv = new TypeVariable("X");
    try {
  ...
  public void testCanBindToUpperMatch() {
    final TypeVariable tv = new TypeVariable("X", javaLangNumber);
    tv.resolve(world);
  ...
  public void testCanBindToInterfaceMatch() {
    final TypeVariable tv = new TypeVariable("T", javaLangNumber, new UnresolvedType[]{javaIoSerializable});
    tv.resolve(world);
    assertTrue(tv.canBeBoundTo(javaLangDouble.resolve(world)));
  }
