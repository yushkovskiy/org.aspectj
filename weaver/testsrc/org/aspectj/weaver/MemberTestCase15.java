...
public class MemberTestCase15 extends TestCase {
  ...
  public void testCanBeParameterizedRegularMethod() {
    ...
    final ResolvedType javaLangClass = world.resolve(UnresolvedType.forName("java/lang/Class"));
    final ResolvedMember[] methods = javaLangClass.getDeclaredMethods();
...
//	    		System.out.println("got it");
  ...
  public void testCanBeParameterizedMethodInGenericType() {
    ...
    final ResolvedMember[] methods = javaUtilList.getDeclaredMethods();
