...
public class BoundedReferenceTypeTestCase extends TestCase {
  ...
  public void testSignature() {
    final String extendsSig = extendsClass.getSignature();
  ...
  public void testGetDeclaredInterfacesNoAdditions() {
    final ResolvedType[] rt1 = extendsClass.getDeclaredInterfaces();
    final ResolvedType[] rt2 = javaLangClass.getDeclaredInterfaces();
  ...
  public void testGetDeclaredInterfacesWithInterfaceBounds() {
    final ResolvedType[] rt1 = extendsWithExtras.getDeclaredInterfaces();
    final ResolvedType[] rt2 = javaLangClass.getDeclaredInterfaces();
  ...
  public void testGetDeclaredMethodsExtends() {
    final ResolvedMember[] rm1 = extendsClass.getDeclaredMethods();
    final ResolvedMember[] rm2 = javaLangClass.getDeclaredMethods();
  ...
  public void testGetDeclaredMethodsSuper() {
    final ResolvedMember[] rm1 = superClass.getDeclaredMethods();
    final ResolvedMember[] rm2 = javaLangObject.getDeclaredMethods();
    assertEquals("same length", rm1.length, rm2.length);
    for (int i = 0; i < rm2.length; i++) {
      assertEquals("same methods", rm1[i], rm2[i]);
    }
