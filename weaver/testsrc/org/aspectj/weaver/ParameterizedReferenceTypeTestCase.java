...
public class ParameterizedReferenceTypeTestCase extends TestCase {
  ...
  public void testDeclaredMethodWithParameter() {
    final ResolvedMember[] methods = listOfString.getDeclaredMethods();
    ...
    final UnresolvedType parameterType = add.getParameterTypes()[0];
    ...
    final UnresolvedType returnType = get.getReturnType();
  ...
  public void testDeclaredMethodWithParameterizedReturnType() {
    ...
    final UnresolvedType returnType = iterator.getReturnType();
