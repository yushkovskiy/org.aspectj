...
public class ZippedFileCacheBackingTest extends AsynchronousFileCacheBackingTestSupport {
  ...
  public void testReadIndex() throws Exception {
    ...
    final Map<String, byte[]> entriesMap = new TreeMap<String, byte[]>();
  ...
  public void testReadWriteZipClassBytes() throws IOException {
    ...
    for (int index = 0; index < Byte.SIZE; index++) {
      final String name = "classBytes#" + index;
    ...
    final Map<String, byte[]> bytesMap = ZippedFileCacheBacking.readZipClassBytes(zipFile);
    ...
    for (Map.Entry<String, byte[]> bytesEntry : entriesMap.entrySet()) {
      ...
      final byte[] expected = bytesEntry.getValue();
      final byte[] actual = bytesMap.get(key);
