...
public class SimpleClassCacheTest extends TestCase {
  ...
  public void testCache() throws Exception {
    final String classA = "com.generated.A";
    final SimpleCache cache = createCache();

    cache.put(classA, FAKE_BYTES_V1, FAKE_WOVEN_BYTES_V1);


    // Test the returned woven bytes are the original one
    final byte[] result = cache.getAndInitialize(classA, FAKE_BYTES_V1, null, null);
    ...
    final File f = new File(System.getProperty("java.io.tmpdir") + File.separator + "com.generated.A-1164760902");
