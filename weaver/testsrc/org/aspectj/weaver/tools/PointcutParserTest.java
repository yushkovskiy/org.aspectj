...
public class PointcutParserTest extends TestCase {
  ...
  public void testGetAllSupportedPointcutPrimitives() {
    ...
    final Set<PointcutPrimitive> s = PointcutParser.getAllSupportedPointcutPrimitives();
  ...
  public void testEmptyConstructor() {
    ...
    final Set<PointcutPrimitive> s = parser.getSupportedPrimitives();
    assertEquals("Should be 21 elements in the set", 21, s.size());
    assertFalse("Should not contain if pcd", s.contains(PointcutPrimitive.IF));
    assertFalse("Should not contain cflow pcd", s.contains(PointcutPrimitive.CFLOW));
    assertFalse("Should not contain cflowbelow pcd", s.contains(PointcutPrimitive.CFLOW_BELOW));
  ...
  public void testSetConstructor() {
    ...
    final Set<PointcutPrimitive> p = PointcutParser.getAllSupportedPointcutPrimitives();
    ...
    final Set<PointcutPrimitive> q = new HashSet<PointcutPrimitive>();
  ...
  public void testParsePointcutExpression() {
    ...
    final PointcutParser p = PointcutParser.getPointcutParserSupportingAllPrimitivesAndUsingSpecifiedClassloaderForResolution(this
        .getClass().getClassLoader());
    final IMessageHandler current = p.setCustomMessageHandler(new IgnoreWarningsMessageHandler());
    try {
  ...
  public void testParseReferencePCDs() {
    ...
    final Set pcKinds = PointcutParser.getAllSupportedPointcutPrimitives();
    pcKinds.remove(PointcutPrimitive.REFERENCE);
    final PointcutParser p = PointcutParser.getPointcutParserSupportingSpecifiedPrimitivesAndUsingSpecifiedClassLoaderForResolution(
  ...
  public void testFormals() {
    ...
    final PointcutParser parser = PointcutParser
        .getPointcutParserSupportingAllPrimitivesAndUsingSpecifiedClassloaderForResolution(this.getClass().getClassLoader());
    final PointcutParameter param = parser.createPointcutParameter("x", String.class);
