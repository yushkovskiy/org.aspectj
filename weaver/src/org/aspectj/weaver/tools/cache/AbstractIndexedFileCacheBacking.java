...
public abstract class AbstractIndexedFileCacheBacking extends AbstractFileCacheBacking {
  ...
  protected Map<String, IndexEntry> readIndex(File cacheDir, File cacheFile) {
    final Map<String, IndexEntry> indexMap = new TreeMap<String, IndexEntry>();
    final IndexEntry[] idxValues = readIndex(cacheFile);
    ...
    for (IndexEntry ie : idxValues) {
      final IndexEntry resEntry = resolveIndexMapEntry(cacheDir, ie);
      if (resEntry != null) {
