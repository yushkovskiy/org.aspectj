...
public class BcelAnnotation extends AbstractAnnotationAJ {
  ...
  public String toString() {
    ...
    final List<NameValuePair> nvPairs = bcelAnnotation.getValues();
  ...
  public Set<String> getTargets() {
    ...
    final List<NameValuePair> values = bcelAnnotation.getValues();
    final NameValuePair envp = values.get(0);
    final ArrayElementValue aev = (ArrayElementValue) envp.getValue();
    final ElementValue[] evs = aev.getElementValuesArray();
    final Set<String> targets = new HashSet<String>();
    for (int i = 0; i < evs.length; i++) {
      final EnumElementValue ev = (EnumElementValue) evs[i];
