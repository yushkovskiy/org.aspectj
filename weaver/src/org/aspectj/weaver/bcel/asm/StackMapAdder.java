...
public class StackMapAdder {
  ...
  public static byte[] addStackMaps(World world, byte[] data) {
    try {
      ...
      final ClassWriter cw = new AspectJConnectClassWriter(cr, world);
      final ClassVisitor cv = new AspectJClassVisitor(cw);
      cr.accept(cv, 0);
  ...
  private static class AspectJConnectClassWriter extends ClassWriter {
    ...
    protected String getCommonSuperClass(final String type1, final String type2) {
      ...
      final ResolvedType resolvedType2 = world.resolve(UnresolvedType.forName(type2.replace('/', '.')));
